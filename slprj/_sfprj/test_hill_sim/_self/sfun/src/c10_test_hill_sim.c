...
static const char * c10_debug_family_names[8] = { "r_Earth", "R_Earth_Sun",
  "BETA", "nargin", "nargout", "R_Earth_spacecraft", "R_Sun_Earth", "e_f" };

/* Function Declarations */
static void initialize_c10_test_hill_sim(SFc10_test_hill_simInstanceStruct
  *chartInstance);
static void initialize_params_c10_test_hill_sim
  (SFc10_test_hill_simInstanceStruct *chartInstance);
static void enable_c10_test_hill_sim(SFc10_test_hill_simInstanceStruct
  *chartInstance);
static void disable_c10_test_hill_sim(SFc10_test_hill_simInstanceStruct
  *chartInstance);
static void c10_update_debugger_state_c10_test_hill_sim
  (SFc10_test_hill_simInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c10_test_hill_sim
  (SFc10_test_hill_simInstanceStruct *chartInstance);
static void set_sim_state_c10_test_hill_sim(SFc10_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c10_st);
static void finalize_c10_test_hill_sim(SFc10_test_hill_simInstanceStruct
  *chartInstance);
static void sf_gateway_c10_test_hill_sim(SFc10_test_hill_simInstanceStruct
  *chartInstance);
static void mdl_start_c10_test_hill_sim(SFc10_test_hill_simInstanceStruct
  *chartInstance);
static void initSimStructsc10_test_hill_sim(SFc10_test_hill_simInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c10_machineNumber, uint32_T
  c10_chartNumber, uint32_T c10_instanceNumber);
static const mxArray *c10_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static real_T c10_emlrt_marshallIn(SFc10_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c10_b_e_f, const char_T *c10_identifier);
static real_T c10_b_emlrt_marshallIn(SFc10_test_hill_simInstanceStruct
...
static const mxArray *c10_c_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static void c10_c_emlrt_marshallIn(SFc10_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId,
  real_T c10_y[3]);
...
static real_T c10_eml_xdotc(SFc10_test_hill_simInstanceStruct *chartInstance,
  real_T c10_x[3], real_T c10_y[3]);
static real_T c10_eml_xnrm2(SFc10_test_hill_simInstanceStruct *chartInstance,
  real_T c10_x[3]);
static void c10_below_threshold(SFc10_test_hill_simInstanceStruct *chartInstance);
static void c10_eml_error(SFc10_test_hill_simInstanceStruct *chartInstance);
static const mxArray *c10_d_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static int32_T c10_d_emlrt_marshallIn(SFc10_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static uint8_T c10_e_emlrt_marshallIn(SFc10_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c10_b_is_active_c10_test_hill_sim, const char_T
  *c10_identifier);
static uint8_T c10_f_emlrt_marshallIn(SFc10_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void init_dsm_address_info(SFc10_test_hill_simInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc10_test_hill_simInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c10_is_active_c10_test_hill_sim = 0U;
}
  ...
  (SFc10_test_hill_simInstanceStruct *chartInstance)
{
  ...
  c10_hoistedGlobal = *chartInstance->c10_e_f;
  c10_u = c10_hoistedGlobal;
  c10_b_y = NULL;
  sf_mex_assign(&c10_b_y, sf_mex_create("y", &c10_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c10_y, 0, c10_b_y);
  c10_b_hoistedGlobal = chartInstance->c10_is_active_c10_test_hill_sim;
  ...
  *chartInstance, const mxArray *c10_st)
{
  ...
  *chartInstance->c10_e_f = c10_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c10_u, 0)), "e_f");
  chartInstance->c10_is_active_c10_test_hill_sim = c10_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c10_u, 1)),
     "is_active_c10_test_hill_sim");
  sf_mex_destroy(&c10_u);
  c10_update_debugger_state_c10_test_hill_sim(chartInstance);
  ...
  *chartInstance)
{
  ...
  int32_T c10_i1;
  int32_T c10_i2;
  real_T c10_b_R_Earth_spacecraft[3];
  int32_T c10_i3;
  real_T c10_b_R_Sun_Earth[3];
  uint32_T c10_debug_family_var_map[8];
  real_T c10_r_Earth;
  real_T c10_R_Earth_Sun[3];
  real_T c10_BETA;
  ...
  for (c10_i0 = 0; c10_i0 < 3; c10_i0++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c10_R_Earth_spacecraft)[c10_i0], 0U);
  }

  for (c10_i1 = 0; c10_i1 < 3; c10_i1++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c10_R_Sun_Earth)[c10_i1], 1U);
  }

  chartInstance->c10_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 9U, chartInstance->c10_sfEvent);
  for (c10_i2 = 0; c10_i2 < 3; c10_i2++) {
    c10_b_R_Earth_spacecraft[c10_i2] = (*chartInstance->c10_R_Earth_spacecraft)
      [c10_i2];
  }

  for (c10_i3 = 0; c10_i3 < 3; c10_i3++) {
    c10_b_R_Sun_Earth[c10_i3] = (*chartInstance->c10_R_Sun_Earth)[c10_i3];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 8U, 8U, c10_debug_family_names,
    c10_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_r_Earth, 0U, c10_sf_marshallOut,
    c10_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c10_R_Earth_Sun, 1U, c10_b_sf_marshallOut,
    c10_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_BETA, 2U, c10_sf_marshallOut,
    c10_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_nargout, 4U, c10_sf_marshallOut,
    c10_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c10_b_R_Earth_spacecraft, 5U, c10_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c10_b_R_Sun_Earth, 6U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_b_e_f, 7U, c10_sf_marshallOut,
    c10_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c10_sfEvent, 6);
  c10_r_Earth = 6.378E+6;
  _SFD_EML_CALL(0U, chartInstance->c10_sfEvent, 8);
  for (c10_i4 = 0; c10_i4 < 3; c10_i4++) {
    c10_R_Earth_Sun[c10_i4] = -c10_b_R_Sun_Earth[c10_i4];
  }

  _SFD_EML_CALL(0U, chartInstance->c10_sfEvent, 10);
  for (c10_i5 = 0; c10_i5 < 3; c10_i5++) {
    c10_a[c10_i5] = c10_R_Earth_Sun[c10_i5];
  }

  for (c10_i6 = 0; c10_i6 < 3; c10_i6++) {
    c10_b[c10_i6] = c10_b_R_Earth_spacecraft[c10_i6];
  }

  for (c10_i7 = 0; c10_i7 < 3; c10_i7++) {
    c10_b_a[c10_i7] = c10_a[c10_i7];
  }

  for (c10_i8 = 0; c10_i8 < 3; c10_i8++) {
    c10_b_b[c10_i8] = c10_b[c10_i8];
  }

  c10_c = c10_eml_xdotc(chartInstance, c10_b_a, c10_b_b);
  for (c10_i9 = 0; c10_i9 < 3; c10_i9++) {
    c10_a[c10_i9] = c10_R_Earth_Sun[c10_i9];
  }

  for (c10_i10 = 0; c10_i10 < 3; c10_i10++) {
    c10_c_a[c10_i10] = c10_a[c10_i10];
  }

  c10_y = c10_eml_xnrm2(chartInstance, c10_c_a);
  for (c10_i11 = 0; c10_i11 < 3; c10_i11++) {
    c10_a[c10_i11] = c10_b_R_Earth_spacecraft[c10_i11];
  }
  ...
  c10_b_y = c10_eml_xnrm2(chartInstance, c10_d_a);
  c10_A = c10_c;
  c10_B = c10_y * c10_b_y;
  c10_x = c10_A;
  c10_c_y = c10_B;
  ...
  c10_e_x = c10_BETA;
  c10_BETA = c10_e_x;
  c10_BETA = muDoubleScalarAcos(c10_BETA);
  _SFD_EML_CALL(0U, chartInstance->c10_sfEvent, 12);
  guard1 = false;
  if (CV_EML_COND(0, 1, 0, CV_RELATIONAL_EVAL(4U, 0U, 0, c10_BETA,
        1.5707963267948966, -1, 4U, c10_BETA > 1.5707963267948966))) {
    for (c10_i13 = 0; c10_i13 < 3; c10_i13++) {
      c10_a[c10_i13] = c10_b_R_Earth_spacecraft[c10_i13];
    }

    for (c10_i14 = 0; c10_i14 < 3; c10_i14++) {
      c10_e_a[c10_i14] = c10_a[c10_i14];
    }

    c10_g_y = c10_eml_xnrm2(chartInstance, c10_e_a);
    c10_f_x = 3.1415926535897931 - c10_BETA;
    c10_g_x = c10_f_x;
    c10_g_x = muDoubleScalarSin(c10_g_x);
    c10_d0 = c10_g_y * c10_g_x;
    if (CV_EML_COND(0, 1, 1, CV_RELATIONAL_EVAL(4U, 0U, 1, c10_d0, c10_r_Earth,
          -1, 2U, c10_d0 < c10_r_Earth))) {
  ...
  *chartInstance->c10_e_f = c10_b_e_f;
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c10_e_f, 2U);
}
  ...
  *c10_inData)
{
  ...
  const mxArray *c10_y = NULL;
  SFc10_test_hill_simInstanceStruct *chartInstance;
  chartInstance = (SFc10_test_hill_simInstanceStruct *)chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c10_b_e_f, const char_T *c10_identifier)
{
  ...
  c10_y = c10_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c10_b_e_f),
    &c10_thisId);
  sf_mex_destroy(&c10_b_e_f);
  return c10_y;
}
...
static void c10_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData)
{
  const mxArray *c10_b_e_f;
  const char_T *c10_identifier;
  emlrtMsgIdentifier c10_thisId;
  real_T c10_y;
  SFc10_test_hill_simInstanceStruct *chartInstance;
  chartInstance = (SFc10_test_hill_simInstanceStruct *)chartInstanceVoid;
  c10_b_e_f = sf_mex_dup(c10_mxArrayInData);
  ...
  *c10_inData)
{
  ...
  for (c10_i17 = 0; c10_i17 < 3; c10_i17++) {
    c10_b_inData[c10_i17] = (*(real_T (*)[3])c10_inData)[c10_i17];
  }

  for (c10_i18 = 0; c10_i18 < 3; c10_i18++) {
    c10_u[c10_i18] = c10_b_inData[c10_i18];
  }
  ...
  real_T c10_y[3])
{
  ...
  int32_T c10_i19;
  (void)chartInstance;
  sf_mex_import(c10_parentId, sf_mex_dup(c10_u), c10_dv0, 1, 0, 0U, 1, 0U, 1, 3);
  for (c10_i19 = 0; c10_i19 < 3; c10_i19++) {
    c10_y[c10_i19] = c10_dv0[c10_i19];
  }
  ...
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData)
{
  ...
  SFc10_test_hill_simInstanceStruct *chartInstance;
  chartInstance = (SFc10_test_hill_simInstanceStruct *)chartInstanceVoid;
  c10_R_Earth_Sun = sf_mex_dup(c10_mxArrayInData);
  c10_identifier = c10_varName;
  c10_thisId.fIdentifier = c10_identifier;
  c10_thisId.fParent = NULL;
  c10_c_emlrt_marshallIn(chartInstance, sf_mex_dup(c10_R_Earth_Sun), &c10_thisId,
    c10_y);
  sf_mex_destroy(&c10_R_Earth_Sun);
  for (c10_i20 = 0; c10_i20 < 3; c10_i20++) {
    (*(real_T (*)[3])c10_outData)[c10_i20] = c10_y[c10_i20];
  }

  sf_mex_destroy(&c10_mxArrayInData);
}

const mxArray *sf_c10_test_hill_sim_get_eml_resolved_functions_info(void)
{
  const mxArray *c10_nameCaptureInfo = NULL;
  c10_nameCaptureInfo = NULL;
  sf_mex_assign(&c10_nameCaptureInfo, sf_mex_createstruct("structure", 2, 59, 1),
                false);
...
static void c10_info_helper(const mxArray **c10_info)
{
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("dot"), "name", "name", 0);
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/specfun/dot.m"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1360282354U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/specfun/dot.m"), "context",
                  "context", 1);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("isequal"), "name", "name", 1);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 1);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m"), "resolved",
                  "resolved", 1);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1286818758U), "fileTimeLo",
                  "fileTimeLo", 1);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 1);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_isequal_core.m"),
                  "resolved", "resolved", 2);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1286818786U), "fileTimeLo",
                  "fileTimeLo", 2);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 2);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_isequal_core.m!isequal_scalar"),
                  "context", "context", 3);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("isnan"), "name", "name", 3);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 3);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+refblas/xdot.p"),
                  "context", "context", 16);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "coder.internal.refblas.xdotx"), "name", "name", 16);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 16);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 22);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("isfi"), "name", "name", 22);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("coder.internal.indexInt"),
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 24);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("intmax"), "name", "name", 24);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 24);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 26);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("intmin"), "name", "name", 26);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 26);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("norm"), "name", "name", 28);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 28);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/norm.m!genpnorm"),
                  "context", "context", 31);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("eml_xnrm2"), "name", "name",
                  31);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 31);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1375980692U), "fileTimeLo",
                  "fileTimeLo", 31);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 31);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xnrm2.m"), "context",
                  "context", 33);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("coder.internal.blas.xnrm2"),
                  "name", "name", 33);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 33);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+blas/xnrm2.p!below_threshold"),
                  "context", "context", 35);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "coder.internal.blas.threshold"), "name", "name", 35);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 35);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+blas/threshold.p"),
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+blas/xnrm2.p"),
                  "context", "context", 36);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "coder.internal.refblas.xnrm2"), "name", "name", 36);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 36);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+refblas/xnrm2.p"),
                  "context", "context", 37);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("realmin"), "name", "name",
                  37);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 37);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/realmin.m"), "resolved",
                  "resolved", 37);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1307651242U), "fileTimeLo",
                  "fileTimeLo", 37);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 37);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/realmin.m"), "context",
                  "context", 38);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("eml_realmin"), "name",
                  "name", 38);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 38);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_realmin.m"), "resolved",
                  "resolved", 38);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1307651244U), "fileTimeLo",
                  "fileTimeLo", 38);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 38);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+refblas/xnrm2.p"),
                  "context", "context", 44);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("abs"), "name", "name", 44);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 44);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c10_info, sf_mex_duplicatearraysafe(&c10_lhs46), "lhs", "lhs",
                  46);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(""), "context", "context", 47);
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "resolved",
                  "resolved", 47);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1410807648U), "fileTimeLo",
                  "fileTimeLo", 47);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 47);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1370009886U), "mFileTimeLo",
                  "mFileTimeLo", 47);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 47);
  ...
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1389717774U), "fileTimeLo",
                  "fileTimeLo", 48);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 48);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m"), "resolved",
                  "resolved", 52);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1386423952U), "fileTimeLo",
                  "fileTimeLo", 52);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 52);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c10_info, sf_mex_duplicatearraysafe(&c10_lhs53), "lhs", "lhs",
                  53);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(""), "context", "context", 54);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("acos"), "name", "name", 54);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 54);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/acos.m"), "resolved",
                  "resolved", 54);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1395328492U), "fileTimeLo",
                  "fileTimeLo", 54);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 54);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_error.m"), "resolved",
                  "resolved", 55);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1343830358U), "fileTimeLo",
                  "fileTimeLo", 55);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 55);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/acos.m"), "context",
                  "context", 56);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("eml_scalar_acos"), "name",
                  "name", 56);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 56);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1343830376U), "fileTimeLo",
                  "fileTimeLo", 56);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 56);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c10_info, sf_mex_duplicatearraysafe(&c10_lhs56), "lhs", "lhs",
                  56);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(""), "context", "context", 57);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("sin"), "name", "name", 57);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 57);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sin.m"), "resolved",
                  "resolved", 57);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1395328504U), "fileTimeLo",
                  "fileTimeLo", 57);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 57);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1286818736U), "fileTimeLo",
                  "fileTimeLo", 58);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 58);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  real_T c10_x[3], real_T c10_y[3])
{
  ...
  for (c10_k = 1; c10_k < 4; c10_k++) {
    ...
    c10_d += c10_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK(
      "", (real_T)c10_b_k), 1, 3, 1, 0) - 1] * c10_y[_SFD_EML_ARRAY_BOUNDS_CHECK
...
static void c10_eml_error(SFc10_test_hill_simInstanceStruct *chartInstance)
{
  ...
  const mxArray *c10_y = NULL;
  int32_T c10_i22;
  static char_T c10_cv1[4] = { 'a', 'c', 'o', 's' };

  char_T c10_b_u[4];
  const mxArray *c10_b_y = NULL;
  (void)chartInstance;
  for (c10_i21 = 0; c10_i21 < 30; c10_i21++) {
    c10_u[c10_i21] = c10_cv0[c10_i21];
  }
  ...
  for (c10_i22 = 0; c10_i22 < 4; c10_i22++) {
    c10_b_u[c10_i22] = c10_cv1[c10_i22];
  }
  ...
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId)
{
  ...
  int32_T c10_i23;
  (void)chartInstance;
  sf_mex_import(c10_parentId, sf_mex_dup(c10_u), &c10_i23, 1, 6, 0U, 0, 0U, 0);
  c10_y = c10_i23;
  sf_mex_destroy(&c10_u);
  return c10_y;
}
  ...
  *c10_identifier)
{
  ...
  c10_y = c10_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c10_b_is_active_c10_test_hill_sim), &c10_thisId);
  sf_mex_destroy(&c10_b_is_active_c10_test_hill_sim);
  return c10_y;
}
...
static void init_simulink_io_address(SFc10_test_hill_simInstanceStruct
  *chartInstance)
{
  chartInstance->c10_R_Earth_spacecraft = (real_T (*)[3])
    ssGetInputPortSignal_wrapper(chartInstance->S, 0);
  chartInstance->c10_R_Sun_Earth = (real_T (*)[3])ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c10_e_f = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
}
...
void sf_c10_test_hill_sim_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3778425981U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2862411405U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1888390578U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(232639740U);
}

mxArray* sf_c10_test_hill_sim_get_post_codegen_info(void);
mxArray *sf_c10_test_hill_sim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("Mt0vRI09jaUJFBOgHk0LEB");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c10_test_hill_sim_get_post_codegen_info();
...
mxArray *sf_c10_test_hill_sim_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c10_test_hill_sim_jit_fallback_info(void)
{
...
mxArray *sf_c10_test_hill_sim_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c10_test_hill_sim(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"e_f\",},{M[8],M[0],T\"is_active_c10_test_hill_sim\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c10_test_hill_sim_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc10_test_hill_simInstanceStruct *)
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,1,1,0,"R_Earth_spacecraft");
          _SFD_SET_DATA_PROPS(1,1,1,0,"R_Sun_Earth");
          _SFD_SET_DATA_PROPS(2,2,0,1,"e_f");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",3,-1,295);
        _SFD_CV_INIT_EML_IF(0,1,0,196,259,271,290);

        {
          static int condStart[] = { 199, 212 };

          static int condEnd[] = { 208, 259 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,199,259,2,0,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        _SFD_CV_INIT_EML_RELATIONAL(0,1,0,199,208,-1,4);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,1,212,259,-1,2);
        ...
        _SFD_SET_DATA_VALUE_PTR(0U, *chartInstance->c10_R_Earth_spacecraft);
        _SFD_SET_DATA_VALUE_PTR(1U, *chartInstance->c10_R_Sun_Earth);
        _SFD_SET_DATA_VALUE_PTR(2U, chartInstance->c10_e_f);
      }
    } else {
...
{
  return "aAOlwhXBZFCmkmZXjgtmXE";
}

static void sf_opaque_initialize_c10_test_hill_sim(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc10_test_hill_simInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c10_test_hill_sim((SFc10_test_hill_simInstanceStruct*)
    chartInstanceVar);
  initialize_c10_test_hill_sim((SFc10_test_hill_simInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c10_test_hill_sim(void *chartInstanceVar)
{
  enable_c10_test_hill_sim((SFc10_test_hill_simInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c10_test_hill_sim(void *chartInstanceVar)
{
  disable_c10_test_hill_sim((SFc10_test_hill_simInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c10_test_hill_sim(void *chartInstanceVar)
{
  sf_gateway_c10_test_hill_sim((SFc10_test_hill_simInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c10_test_hill_sim(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c10_test_hill_sim((SFc10_test_hill_simInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c10_test_hill_sim(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c10_test_hill_sim((SFc10_test_hill_simInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c10_test_hill_sim(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc10_test_hill_simInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c10_test_hill_sim((SFc10_test_hill_simInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc10_test_hill_sim((SFc10_test_hill_simInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c10_test_hill_sim(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c10_test_hill_sim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(152061926U));
  ssSetChecksum1(S,(2425331966U));
  ssSetChecksum2(S,(3712046159U));
  ssSetChecksum3(S,(275289510U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c10_test_hill_sim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c10_test_hill_sim(SimStruct *S)
{
  SFc10_test_hill_simInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc10_test_hill_simInstanceStruct *)utMalloc(sizeof
    (SFc10_test_hill_simInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc10_test_hill_simInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c10_test_hill_sim;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c10_test_hill_sim;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c10_test_hill_sim;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c10_test_hill_sim;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c10_test_hill_sim;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c10_test_hill_sim;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c10_test_hill_sim;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c10_test_hill_sim;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c10_test_hill_sim;
  chartInstance->chartInfo.mdlStart = mdlStart_c10_test_hill_sim;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c10_test_hill_sim;
...
void c10_test_hill_sim_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c10_test_hill_sim(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c10_test_hill_sim(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c10_test_hill_sim(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c10_test_hill_sim_method_dispatcher.\n"
