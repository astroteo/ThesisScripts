...
static const char * c12_debug_family_names[11] = { "a_p", "b_p", "Ap", "Cd_p",
  "F_drag", "nargin", "nargout", "rho", "V", "m_cubesat", "a_drag" };

/* Function Declarations */
static void initialize_c12_test_hill_sim(SFc12_test_hill_simInstanceStruct
  *chartInstance);
static void initialize_params_c12_test_hill_sim
  (SFc12_test_hill_simInstanceStruct *chartInstance);
static void enable_c12_test_hill_sim(SFc12_test_hill_simInstanceStruct
  *chartInstance);
static void disable_c12_test_hill_sim(SFc12_test_hill_simInstanceStruct
  *chartInstance);
static void c12_update_debugger_state_c12_test_hill_sim
  (SFc12_test_hill_simInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c12_test_hill_sim
  (SFc12_test_hill_simInstanceStruct *chartInstance);
static void set_sim_state_c12_test_hill_sim(SFc12_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c12_st);
static void finalize_c12_test_hill_sim(SFc12_test_hill_simInstanceStruct
  *chartInstance);
static void sf_gateway_c12_test_hill_sim(SFc12_test_hill_simInstanceStruct
  *chartInstance);
static void mdl_start_c12_test_hill_sim(SFc12_test_hill_simInstanceStruct
  *chartInstance);
static void c12_chartstep_c12_test_hill_sim(SFc12_test_hill_simInstanceStruct
  *chartInstance);
static void initSimStructsc12_test_hill_sim(SFc12_test_hill_simInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c12_machineNumber, uint32_T
  c12_chartNumber, uint32_T c12_instanceNumber);
static const mxArray *c12_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_emlrt_marshallIn(SFc12_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c12_b_a_drag, const char_T *c12_identifier,
  real_T c12_y[3]);
static void c12_b_emlrt_marshallIn(SFc12_test_hill_simInstanceStruct
...
static const mxArray *c12_c_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static real_T c12_c_emlrt_marshallIn(SFc12_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
...
static real_T c12_eml_xnrm2(SFc12_test_hill_simInstanceStruct *chartInstance,
  real_T c12_x[3]);
static void c12_below_threshold(SFc12_test_hill_simInstanceStruct *chartInstance);
static void c12_eml_scalar_eg(SFc12_test_hill_simInstanceStruct *chartInstance);
static const mxArray *c12_d_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static int32_T c12_d_emlrt_marshallIn(SFc12_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static uint8_T c12_e_emlrt_marshallIn(SFc12_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c12_b_is_active_c12_test_hill_sim, const char_T
  *c12_identifier);
static uint8_T c12_f_emlrt_marshallIn(SFc12_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void init_dsm_address_info(SFc12_test_hill_simInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc12_test_hill_simInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c12_is_active_c12_test_hill_sim = 0U;
}
  ...
  (SFc12_test_hill_simInstanceStruct *chartInstance)
{
  ...
  for (c12_i0 = 0; c12_i0 < 3; c12_i0++) {
    c12_u[c12_i0] = (*chartInstance->c12_a_drag)[c12_i0];
  }

  c12_b_y = NULL;
  sf_mex_assign(&c12_b_y, sf_mex_create("y", c12_u, 0, 0U, 1U, 0U, 1, 3), false);
  sf_mex_setcell(c12_y, 0, c12_b_y);
  c12_hoistedGlobal = chartInstance->c12_is_active_c12_test_hill_sim;
  ...
  *chartInstance, const mxArray *c12_st)
{
  ...
  for (c12_i1 = 0; c12_i1 < 3; c12_i1++) {
    (*chartInstance->c12_a_drag)[c12_i1] = c12_dv0[c12_i1];
  }

  chartInstance->c12_is_active_c12_test_hill_sim = c12_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c12_u, 1)),
     "is_active_c12_test_hill_sim");
  sf_mex_destroy(&c12_u);
  c12_update_debugger_state_c12_test_hill_sim(chartInstance);
  ...
  *chartInstance)
{
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c12_rho, 0U);
  for (c12_i2 = 0; c12_i2 < 3; c12_i2++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c12_V)[c12_i2], 1U);
  }

  chartInstance->c12_sfEvent = CALL_EVENT;
  c12_chartstep_c12_test_hill_sim(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_test_hill_simMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  for (c12_i3 = 0; c12_i3 < 3; c12_i3++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c12_a_drag)[c12_i3], 2U);
  }

  _SFD_DATA_RANGE_CHECK(*chartInstance->c12_m_cubesat, 3U);
}
  ...
  *chartInstance)
{
  ...
  c12_hoistedGlobal = *chartInstance->c12_rho;
  c12_b_hoistedGlobal = *chartInstance->c12_m_cubesat;
  c12_b_rho = c12_hoistedGlobal;
  for (c12_i4 = 0; c12_i4 < 3; c12_i4++) {
    c12_b_V[c12_i4] = (*chartInstance->c12_V)[c12_i4];
  }

  c12_b_m_cubesat = c12_b_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 11U, 11U, c12_debug_family_names,
    c12_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c12_a_p, 0U, c12_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c12_b_p, 1U, c12_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c12_Ap, 2U, c12_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c12_Cd_p, 3U, c12_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c12_F_drag, 4U, c12_sf_marshallOut,
    c12_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c12_nargin, 5U, c12_b_sf_marshallOut,
    c12_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c12_nargout, 6U, c12_b_sf_marshallOut,
    c12_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c12_b_rho, 7U, c12_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c12_b_V, 8U, c12_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c12_b_m_cubesat, 9U, c12_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c12_b_a_drag, 10U, c12_sf_marshallOut,
    c12_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c12_sfEvent, 6);
  for (c12_i5 = 0; c12_i5 < 3; c12_i5++) {
    c12_b_a_drag[c12_i5] = 0.0;
  }
  ...
  for (c12_i6 = 0; c12_i6 < 3; c12_i6++) {
    c12_x[c12_i6] = c12_b_V[c12_i6];
  }

  for (c12_i7 = 0; c12_i7 < 3; c12_i7++) {
    c12_b_x[c12_i7] = c12_x[c12_i7];
  }

  c12_y = c12_eml_xnrm2(chartInstance, c12_b_x);
  c12_a = c12_y;
  c12_b_a = c12_a;
  c12_c_a = c12_b_a;
  ...
  for (c12_i8 = 0; c12_i8 < 3; c12_i8++) {
    c12_x[c12_i8] = c12_b_V[c12_i8];
  }

  for (c12_i9 = 0; c12_i9 < 3; c12_i9++) {
    c12_c_x[c12_i9] = c12_x[c12_i9];
  }

  c12_b_y = c12_eml_xnrm2(chartInstance, c12_c_x);
  for (c12_i10 = 0; c12_i10 < 3; c12_i10++) {
    c12_x[c12_i10] = c12_b_V[c12_i10];
  }
  ...
  for (c12_i11 = 0; c12_i11 < 3; c12_i11++) {
    c12_x[c12_i11] /= c12_e_y;
  }

  c12_e_a = -0.09 * c12_b_rho * 0.5 * 2.0 * c12_c;
  for (c12_i12 = 0; c12_i12 < 3; c12_i12++) {
    c12_F_drag[c12_i12] = c12_e_a * c12_x[c12_i12];
  }

  _SFD_EML_CALL(0U, chartInstance->c12_sfEvent, 17);
  for (c12_i13 = 0; c12_i13 < 3; c12_i13++) {
    c12_x[c12_i13] = c12_F_drag[c12_i13];
  }

  c12_b_B = c12_b_m_cubesat;
  c12_f_y = c12_b_B;
  c12_g_y = c12_f_y;
  c12_h_y = c12_g_y;
  for (c12_i14 = 0; c12_i14 < 3; c12_i14++) {
    c12_b_a_drag[c12_i14] = c12_x[c12_i14] / c12_h_y;
  }

  _SFD_EML_CALL(0U, chartInstance->c12_sfEvent, -17);
  _SFD_SYMBOL_SCOPE_POP();
  for (c12_i15 = 0; c12_i15 < 3; c12_i15++) {
    (*chartInstance->c12_a_drag)[c12_i15] = c12_b_a_drag[c12_i15];
  }
  ...
  *c12_inData)
{
  ...
  const mxArray *c12_y = NULL;
  SFc12_test_hill_simInstanceStruct *chartInstance;
  chartInstance = (SFc12_test_hill_simInstanceStruct *)chartInstanceVoid;
  ...
  real_T c12_y[3])
{
  ...
  c12_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c12_b_a_drag), &c12_thisId,
    c12_y);
  sf_mex_destroy(&c12_b_a_drag);
}
  ...
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData)
{
  ...
  SFc12_test_hill_simInstanceStruct *chartInstance;
  chartInstance = (SFc12_test_hill_simInstanceStruct *)chartInstanceVoid;
  c12_b_a_drag = sf_mex_dup(c12_mxArrayInData);
  ...
  for (c12_i19 = 0; c12_i19 < 3; c12_i19++) {
    (*(real_T (*)[3])c12_outData)[c12_i19] = c12_y[c12_i19];
  }
  ...
  *c12_inData)
{
  ...
  for (c12_i20 = 0; c12_i20 < 3; c12_i20++) {
    c12_b_inData[c12_i20] = (*(real_T (*)[3])c12_inData)[c12_i20];
  }

  for (c12_i21 = 0; c12_i21 < 3; c12_i21++) {
    c12_u[c12_i21] = c12_b_inData[c12_i21];
  }
...
const mxArray *sf_c12_test_hill_sim_get_eml_resolved_functions_info(void)
{
  const mxArray *c12_nameCaptureInfo = NULL;
  c12_nameCaptureInfo = NULL;
  sf_mex_assign(&c12_nameCaptureInfo, sf_mex_createstruct("structure", 2, 48, 1),
                false);
...
static void c12_info_helper(const mxArray **c12_info)
{
  ...
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("norm"), "name", "name", 7);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 7);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/norm.m"), "resolved",
                  "resolved", 7);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(1363713868U), "fileTimeLo",
                  "fileTimeLo", 7);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 7);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/norm.m!genpnorm"),
                  "context", "context", 10);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("eml_xnrm2"), "name", "name",
                  10);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 10);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(1375980692U), "fileTimeLo",
                  "fileTimeLo", 10);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 10);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xnrm2.m"), "context",
                  "context", 12);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("coder.internal.blas.xnrm2"),
                  "name", "name", 12);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 12);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+refblas/xnrm2.p"),
                  "context", "context", 17);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("realmin"), "name", "name",
                  17);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 17);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/realmin.m"), "resolved",
                  "resolved", 17);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(1307651242U), "fileTimeLo",
                  "fileTimeLo", 17);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 17);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/realmin.m"), "context",
                  "context", 18);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("eml_realmin"), "name",
                  "name", 18);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 18);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_realmin.m"), "resolved",
                  "resolved", 18);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(1307651244U), "fileTimeLo",
                  "fileTimeLo", 18);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 18);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(1326727996U), "fileTimeLo",
                  "fileTimeLo", 19);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 19);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(1372583160U), "fileTimeLo",
                  "fileTimeLo", 20);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 20);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(1397257422U), "fileTimeLo",
                  "fileTimeLo", 23);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 23);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 24);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("isfi"), "name", "name", 24);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("coder.internal.indexInt"),
  ...
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 26);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("intmax"), "name", "name", 26);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 26);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 28);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("intmin"), "name", "name", 28);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 28);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+refblas/xnrm2.p"),
                  "context", "context", 30);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("abs"), "name", "name", 30);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 30);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m"), "resolved",
                  "resolved", 30);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(1363713852U), "fileTimeLo",
                  "fileTimeLo", 30);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 30);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(1286818712U), "fileTimeLo",
                  "fileTimeLo", 32);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 32);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c12_info, sf_mex_duplicatearraysafe(&c12_lhs32), "lhs", "lhs",
                  32);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(""), "context", "context", 33);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("mpower"), "name", "name", 33);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 33);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 36);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("power"), "name", "name", 36);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 36);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m"), "resolved",
                  "resolved", 36);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(1395328506U), "fileTimeLo",
                  "fileTimeLo", 36);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 36);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m!fltpower"), "context",
                  "context", 42);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("floor"), "name", "name", 42);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 42);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c12_info, sf_mex_duplicatearraysafe(&c12_lhs45), "lhs", "lhs",
                  45);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(""), "context", "context", 46);
  ...
  real_T c12_x[3])
{
  ...
  c12_y = 0.0;
  c12_scale = 2.2250738585072014E-308;
  for (c12_k = 1; c12_k < 4; c12_k++) {
    c12_b_k = c12_k;
    c12_b_x = c12_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK(
      "", (real_T)c12_b_k), 1, 3, 1, 0) - 1];
    c12_c_x = c12_b_x;
    c12_absxk = muDoubleScalarAbs(c12_c_x);
    if (c12_absxk > c12_scale) {
      c12_t = c12_scale / c12_absxk;
      c12_y = 1.0 + c12_y * c12_t * c12_t;
      c12_scale = c12_absxk;
    } else {
      c12_t = c12_absxk / c12_scale;
      c12_y += c12_t * c12_t;
    }
  }

  return c12_scale * muDoubleScalarSqrt(c12_y);
}
  ...
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId)
{
  ...
  int32_T c12_i22;
  (void)chartInstance;
  sf_mex_import(c12_parentId, sf_mex_dup(c12_u), &c12_i22, 1, 6, 0U, 0, 0U, 0);
  c12_y = c12_i22;
  sf_mex_destroy(&c12_u);
  return c12_y;
}
  ...
  *c12_identifier)
{
  ...
  c12_y = c12_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c12_b_is_active_c12_test_hill_sim), &c12_thisId);
  sf_mex_destroy(&c12_b_is_active_c12_test_hill_sim);
  return c12_y;
}
...
static void init_simulink_io_address(SFc12_test_hill_simInstanceStruct
  *chartInstance)
{
  chartInstance->c12_rho = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c12_V = (real_T (*)[3])ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c12_a_drag = (real_T (*)[3])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c12_m_cubesat = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 2);
}
...
void sf_c12_test_hill_sim_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3966415025U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2889004796U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(492483895U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3650533607U);
}

mxArray* sf_c12_test_hill_sim_get_post_codegen_info(void);
mxArray *sf_c12_test_hill_sim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("zGRCC5HaYAKYKT69O5JXh");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c12_test_hill_sim_get_post_codegen_info();
...
mxArray *sf_c12_test_hill_sim_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c12_test_hill_sim_jit_fallback_info(void)
{
...
mxArray *sf_c12_test_hill_sim_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c12_test_hill_sim(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"a_drag\",},{M[8],M[0],T\"is_active_c12_test_hill_sim\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c12_test_hill_sim_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc12_test_hill_simInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(2,2,0,1,"a_drag");
          _SFD_SET_DATA_PROPS(3,1,1,0,"m_cubesat");
        ...
        _SFD_SET_DATA_COMPILED_PROPS(3,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,0,
          (MexFcnForType)c12_b_sf_marshallOut,(MexInFcnForType)NULL);
        _SFD_SET_DATA_VALUE_PTR(0U, chartInstance->c12_rho);
        _SFD_SET_DATA_VALUE_PTR(1U, *chartInstance->c12_V);
        _SFD_SET_DATA_VALUE_PTR(2U, *chartInstance->c12_a_drag);
        _SFD_SET_DATA_VALUE_PTR(3U, chartInstance->c12_m_cubesat);
      }
    } else {
...
{
  return "G4ncdIOiWyYdA5wrqTxnbD";
}

static void sf_opaque_initialize_c12_test_hill_sim(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc12_test_hill_simInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c12_test_hill_sim((SFc12_test_hill_simInstanceStruct*)
    chartInstanceVar);
  initialize_c12_test_hill_sim((SFc12_test_hill_simInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c12_test_hill_sim(void *chartInstanceVar)
{
  enable_c12_test_hill_sim((SFc12_test_hill_simInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c12_test_hill_sim(void *chartInstanceVar)
{
  disable_c12_test_hill_sim((SFc12_test_hill_simInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c12_test_hill_sim(void *chartInstanceVar)
{
  sf_gateway_c12_test_hill_sim((SFc12_test_hill_simInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c12_test_hill_sim(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c12_test_hill_sim((SFc12_test_hill_simInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c12_test_hill_sim(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c12_test_hill_sim((SFc12_test_hill_simInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c12_test_hill_sim(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc12_test_hill_simInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c12_test_hill_sim((SFc12_test_hill_simInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc12_test_hill_sim((SFc12_test_hill_simInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c12_test_hill_sim(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c12_test_hill_sim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2251405033U));
  ssSetChecksum1(S,(967827778U));
  ssSetChecksum2(S,(1234397633U));
  ssSetChecksum3(S,(1720808167U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c12_test_hill_sim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c12_test_hill_sim(SimStruct *S)
{
  SFc12_test_hill_simInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc12_test_hill_simInstanceStruct *)utMalloc(sizeof
    (SFc12_test_hill_simInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc12_test_hill_simInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c12_test_hill_sim;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c12_test_hill_sim;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c12_test_hill_sim;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c12_test_hill_sim;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c12_test_hill_sim;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c12_test_hill_sim;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c12_test_hill_sim;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c12_test_hill_sim;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c12_test_hill_sim;
  chartInstance->chartInfo.mdlStart = mdlStart_c12_test_hill_sim;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c12_test_hill_sim;
...
void c12_test_hill_sim_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c12_test_hill_sim(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c12_test_hill_sim(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c12_test_hill_sim(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c12_test_hill_sim_method_dispatcher.\n"
