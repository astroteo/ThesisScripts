...
static const char * c9_debug_family_names[7] = { "Mu_Earth", "Mu_Moon",
  "R_c_Moon_mod", "nargin", "nargout", "R_c_Moon", "a_Moon" };

/* Function Declarations */
static void initialize_c9_test_hill_sim(SFc9_test_hill_simInstanceStruct
  *chartInstance);
static void initialize_params_c9_test_hill_sim(SFc9_test_hill_simInstanceStruct *
  chartInstance);
static void enable_c9_test_hill_sim(SFc9_test_hill_simInstanceStruct
  *chartInstance);
static void disable_c9_test_hill_sim(SFc9_test_hill_simInstanceStruct
  *chartInstance);
static void c9_update_debugger_state_c9_test_hill_sim
  (SFc9_test_hill_simInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c9_test_hill_sim
  (SFc9_test_hill_simInstanceStruct *chartInstance);
static void set_sim_state_c9_test_hill_sim(SFc9_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c9_st);
static void finalize_c9_test_hill_sim(SFc9_test_hill_simInstanceStruct
  *chartInstance);
static void sf_gateway_c9_test_hill_sim(SFc9_test_hill_simInstanceStruct
  *chartInstance);
static void mdl_start_c9_test_hill_sim(SFc9_test_hill_simInstanceStruct
  *chartInstance);
static void initSimStructsc9_test_hill_sim(SFc9_test_hill_simInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c9_machineNumber, uint32_T
  c9_chartNumber, uint32_T c9_instanceNumber);
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData);
static void c9_emlrt_marshallIn(SFc9_test_hill_simInstanceStruct *chartInstance,
  const mxArray *c9_b_a_Moon, const char_T *c9_identifier, real_T c9_y[3]);
static void c9_b_emlrt_marshallIn(SFc9_test_hill_simInstanceStruct
...
static const mxArray *c9_b_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static real_T c9_c_emlrt_marshallIn(SFc9_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
...
static real_T c9_eml_xnrm2(SFc9_test_hill_simInstanceStruct *chartInstance,
  real_T c9_x[3]);
static void c9_below_threshold(SFc9_test_hill_simInstanceStruct *chartInstance);
static void c9_eml_scalar_eg(SFc9_test_hill_simInstanceStruct *chartInstance);
static const mxArray *c9_c_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static int32_T c9_d_emlrt_marshallIn(SFc9_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData);
static uint8_T c9_e_emlrt_marshallIn(SFc9_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c9_b_is_active_c9_test_hill_sim, const char_T
  *c9_identifier);
static uint8_T c9_f_emlrt_marshallIn(SFc9_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void init_dsm_address_info(SFc9_test_hill_simInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc9_test_hill_simInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c9_is_active_c9_test_hill_sim = 0U;
}
  ...
  (SFc9_test_hill_simInstanceStruct *chartInstance)
{
  ...
  for (c9_i0 = 0; c9_i0 < 3; c9_i0++) {
    c9_u[c9_i0] = (*chartInstance->c9_a_Moon)[c9_i0];
  }

  c9_b_y = NULL;
  sf_mex_assign(&c9_b_y, sf_mex_create("y", c9_u, 0, 0U, 1U, 0U, 1, 3), false);
  sf_mex_setcell(c9_y, 0, c9_b_y);
  c9_hoistedGlobal = chartInstance->c9_is_active_c9_test_hill_sim;
  ...
  *chartInstance, const mxArray *c9_st)
{
  ...
  for (c9_i1 = 0; c9_i1 < 3; c9_i1++) {
    (*chartInstance->c9_a_Moon)[c9_i1] = c9_dv0[c9_i1];
  }

  chartInstance->c9_is_active_c9_test_hill_sim = c9_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c9_u, 1)),
     "is_active_c9_test_hill_sim");
  sf_mex_destroy(&c9_u);
  c9_update_debugger_state_c9_test_hill_sim(chartInstance);
  ...
  *chartInstance)
{
  int32_T c9_i2;
  int32_T c9_i3;
  real_T c9_b_R_c_Moon[3];
  uint32_T c9_debug_family_var_map[7];
  real_T c9_Mu_Earth;
  real_T c9_Mu_Moon;
  real_T c9_R_c_Moon_mod;
  real_T c9_nargin = 1.0;
  real_T c9_nargout = 1.0;
  real_T c9_b_a_Moon[3];
  int32_T c9_i4;
  int32_T c9_i5;
  real_T c9_x[3];
  int32_T c9_i6;
  ...
  for (c9_i2 = 0; c9_i2 < 3; c9_i2++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c9_R_c_Moon)[c9_i2], 0U);
  }

  chartInstance->c9_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 8U, chartInstance->c9_sfEvent);
  for (c9_i3 = 0; c9_i3 < 3; c9_i3++) {
    c9_b_R_c_Moon[c9_i3] = (*chartInstance->c9_R_c_Moon)[c9_i3];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 7U, 7U, c9_debug_family_names,
    c9_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c9_Mu_Earth, 0U, c9_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c9_Mu_Moon, 1U, c9_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_R_c_Moon_mod, 2U, c9_b_sf_marshallOut,
    c9_b_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c9_nargout, 4U, c9_b_sf_marshallOut,
    c9_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c9_b_R_c_Moon, 5U, c9_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c9_b_a_Moon, 6U, c9_sf_marshallOut,
    c9_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c9_sfEvent, 3);
  for (c9_i4 = 0; c9_i4 < 3; c9_i4++) {
    c9_b_a_Moon[c9_i4] = 0.0;
  }

  _SFD_EML_CALL(0U, chartInstance->c9_sfEvent, 4);
  c9_Mu_Earth = 3.986E+14;
  _SFD_EML_CALL(0U, chartInstance->c9_sfEvent, 5);
  c9_Mu_Moon = 4.7832E+12;
  _SFD_EML_CALL(0U, chartInstance->c9_sfEvent, 6);
  for (c9_i5 = 0; c9_i5 < 3; c9_i5++) {
    c9_x[c9_i5] = c9_b_R_c_Moon[c9_i5];
  }
  ...
  c9_R_c_Moon_mod = c9_eml_xnrm2(chartInstance, c9_b_x);
  _SFD_EML_CALL(0U, chartInstance->c9_sfEvent, 7);
  c9_a = c9_R_c_Moon_mod;
  c9_b_a = c9_a;
  c9_c_a = c9_b_a;
  ...
  c9_b_y = c9_y;
  c9_c_y = c9_b_y;
  c9_d_y = -4.7832E+12 / c9_c_y;
  c9_e_a = c9_d_y;
  for (c9_i7 = 0; c9_i7 < 3; c9_i7++) {
    c9_x[c9_i7] = c9_b_R_c_Moon[c9_i7];
  }

  for (c9_i8 = 0; c9_i8 < 3; c9_i8++) {
    c9_b_a_Moon[c9_i8] = c9_e_a * c9_x[c9_i8];
  }

  _SFD_EML_CALL(0U, chartInstance->c9_sfEvent, -7);
  _SFD_SYMBOL_SCOPE_POP();
  for (c9_i9 = 0; c9_i9 < 3; c9_i9++) {
    (*chartInstance->c9_a_Moon)[c9_i9] = c9_b_a_Moon[c9_i9];
  }
  ...
  for (c9_i10 = 0; c9_i10 < 3; c9_i10++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c9_a_Moon)[c9_i10], 1U);
  }
}
...
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData)
{
  ...
  const mxArray *c9_y = NULL;
  SFc9_test_hill_simInstanceStruct *chartInstance;
  chartInstance = (SFc9_test_hill_simInstanceStruct *)chartInstanceVoid;
  c9_mxArrayOutData = NULL;
  for (c9_i11 = 0; c9_i11 < 3; c9_i11++) {
    c9_b_inData[c9_i11] = (*(real_T (*)[3])c9_inData)[c9_i11];
  }

  for (c9_i12 = 0; c9_i12 < 3; c9_i12++) {
    c9_u[c9_i12] = c9_b_inData[c9_i12];
  }
  ...
  const mxArray *c9_b_a_Moon, const char_T *c9_identifier, real_T c9_y[3])
{
  ...
  c9_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c9_b_a_Moon), &c9_thisId, c9_y);
  sf_mex_destroy(&c9_b_a_Moon);
}
  ...
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData)
{
  ...
  SFc9_test_hill_simInstanceStruct *chartInstance;
  chartInstance = (SFc9_test_hill_simInstanceStruct *)chartInstanceVoid;
  c9_b_a_Moon = sf_mex_dup(c9_mxArrayInData);
  ...
  for (c9_i14 = 0; c9_i14 < 3; c9_i14++) {
    (*(real_T (*)[3])c9_outData)[c9_i14] = c9_y[c9_i14];
  }
...
const mxArray *sf_c9_test_hill_sim_get_eml_resolved_functions_info(void)
{
  const mxArray *c9_nameCaptureInfo = NULL;
  c9_nameCaptureInfo = NULL;
  sf_mex_assign(&c9_nameCaptureInfo, sf_mex_createstruct("structure", 2, 48, 1),
                false);
...
static void c9_info_helper(const mxArray **c9_info)
{
  ...
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("norm"), "name", "name", 0);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 0);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/norm.m"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(1363713868U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/norm.m!genpnorm"),
                  "context", "context", 3);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("eml_xnrm2"), "name", "name", 3);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 3);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xnrm2.m"),
                  "resolved", "resolved", 3);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(1375980692U), "fileTimeLo",
                  "fileTimeLo", 3);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 3);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+blas/inline.p"),
                  "resolved", "resolved", 4);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(1410807772U), "fileTimeLo",
                  "fileTimeLo", 4);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 4);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+refblas/xnrm2.p"),
                  "context", "context", 10);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("realmin"), "name", "name", 10);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 10);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/realmin.m"), "resolved",
                  "resolved", 10);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(1307651242U), "fileTimeLo",
                  "fileTimeLo", 10);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 10);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_realmin.m"), "resolved",
                  "resolved", 11);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(1307651244U), "fileTimeLo",
                  "fileTimeLo", 11);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 11);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(1326727996U), "fileTimeLo",
                  "fileTimeLo", 12);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 12);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(1372583160U), "fileTimeLo",
                  "fileTimeLo", 13);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 13);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(1397257422U), "fileTimeLo",
                  "fileTimeLo", 16);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 16);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 21);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("intmin"), "name", "name", 21);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 21);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+refblas/xnrm2.p"),
                  "context", "context", 23);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("abs"), "name", "name", 23);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 23);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c9_info, sf_mex_duplicatearraysafe(&c9_lhs25), "lhs", "lhs",
                  25);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut(""), "context", "context", 26);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("mpower"), "name", "name", 26);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 26);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 29);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("power"), "name", "name", 29);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 29);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m"), "resolved",
                  "resolved", 29);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(1395328506U), "fileTimeLo",
                  "fileTimeLo", 29);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 29);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("mrdivide"), "name", "name", 39);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 39);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "resolved",
                  "resolved", 39);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(1410807648U), "fileTimeLo",
                  "fileTimeLo", 39);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 39);
  ...
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(1389717774U), "fileTimeLo",
                  "fileTimeLo", 40);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 40);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "context",
                  "context", 41);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("rdivide"), "name", "name", 41);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 41);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 44);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("eml_div"), "name", "name", 44);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 44);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m"), "resolved",
                  "resolved", 44);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(1386423952U), "fileTimeLo",
                  "fileTimeLo", 44);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 44);
  sf_mex_addfield(*c9_info, c9_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c9_info, sf_mex_duplicatearraysafe(&c9_lhs45), "lhs", "lhs",
                  45);
  sf_mex_addfield(*c9_info, c9_emlrt_marshallOut(""), "context", "context", 46);
  ...
  *c9_identifier)
{
  ...
  c9_y = c9_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c9_b_is_active_c9_test_hill_sim), &c9_thisId);
  sf_mex_destroy(&c9_b_is_active_c9_test_hill_sim);
  return c9_y;
}
...
static void init_simulink_io_address(SFc9_test_hill_simInstanceStruct
  *chartInstance)
{
  chartInstance->c9_R_c_Moon = (real_T (*)[3])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c9_a_Moon = (real_T (*)[3])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
}
...
void sf_c9_test_hill_sim_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(764386091U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1868640234U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4220429716U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(166228659U);
}

mxArray* sf_c9_test_hill_sim_get_post_codegen_info(void);
mxArray *sf_c9_test_hill_sim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("6FGv3FCeGqDujgJNkeZ0zD");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c9_test_hill_sim_get_post_codegen_info();
...
mxArray *sf_c9_test_hill_sim_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c9_test_hill_sim_jit_fallback_info(void)
{
...
mxArray *sf_c9_test_hill_sim_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c9_test_hill_sim(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"a_Moon\",},{M[8],M[0],T\"is_active_c9_test_hill_sim\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c9_test_hill_sim_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc9_test_hill_simInstanceStruct *)
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,1,1,0,"R_c_Moon");
          _SFD_SET_DATA_PROPS(1,2,0,1,"a_Moon");
        ...
        _SFD_SET_DATA_VALUE_PTR(0U, *chartInstance->c9_R_c_Moon);
        _SFD_SET_DATA_VALUE_PTR(1U, *chartInstance->c9_a_Moon);
      }
    } else {
...
{
  return "8X2ew74QSX1h6e4TuAPnhG";
}

static void sf_opaque_initialize_c9_test_hill_sim(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc9_test_hill_simInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c9_test_hill_sim((SFc9_test_hill_simInstanceStruct*)
    chartInstanceVar);
  initialize_c9_test_hill_sim((SFc9_test_hill_simInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c9_test_hill_sim(void *chartInstanceVar)
{
  enable_c9_test_hill_sim((SFc9_test_hill_simInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c9_test_hill_sim(void *chartInstanceVar)
{
  disable_c9_test_hill_sim((SFc9_test_hill_simInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c9_test_hill_sim(void *chartInstanceVar)
{
  sf_gateway_c9_test_hill_sim((SFc9_test_hill_simInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c9_test_hill_sim(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c9_test_hill_sim((SFc9_test_hill_simInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c9_test_hill_sim(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c9_test_hill_sim((SFc9_test_hill_simInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c9_test_hill_sim(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc9_test_hill_simInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c9_test_hill_sim((SFc9_test_hill_simInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc9_test_hill_sim((SFc9_test_hill_simInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c9_test_hill_sim(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c9_test_hill_sim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3658287033U));
  ssSetChecksum1(S,(2098132074U));
  ssSetChecksum2(S,(2089358039U));
  ssSetChecksum3(S,(888546506U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c9_test_hill_sim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c9_test_hill_sim(SimStruct *S)
{
  SFc9_test_hill_simInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc9_test_hill_simInstanceStruct *)utMalloc(sizeof
    (SFc9_test_hill_simInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc9_test_hill_simInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c9_test_hill_sim;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c9_test_hill_sim;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c9_test_hill_sim;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c9_test_hill_sim;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c9_test_hill_sim;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c9_test_hill_sim;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c9_test_hill_sim;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c9_test_hill_sim;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c9_test_hill_sim;
  chartInstance->chartInfo.mdlStart = mdlStart_c9_test_hill_sim;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c9_test_hill_sim;
...
void c9_test_hill_sim_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c9_test_hill_sim(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c9_test_hill_sim(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c9_test_hill_sim(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c9_test_hill_sim_method_dispatcher.\n"
