...
static const char * c2_debug_family_names[21] = { "mu", "rm", "vm", "h", "hm",
  "l", "e", "kv", "jv", "iv", "n", "v", "r", "nargin", "nargout", "a", "em", "i",
  "OM", "om", "theta" };

/* Function Declarations */
static void initialize_c2_test_hill_sim(SFc2_test_hill_simInstanceStruct
  *chartInstance);
static void initialize_params_c2_test_hill_sim(SFc2_test_hill_simInstanceStruct *
  chartInstance);
static void enable_c2_test_hill_sim(SFc2_test_hill_simInstanceStruct
  *chartInstance);
static void disable_c2_test_hill_sim(SFc2_test_hill_simInstanceStruct
  *chartInstance);
static void c2_update_debugger_state_c2_test_hill_sim
  (SFc2_test_hill_simInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_test_hill_sim
  (SFc2_test_hill_simInstanceStruct *chartInstance);
static void set_sim_state_c2_test_hill_sim(SFc2_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_test_hill_sim(SFc2_test_hill_simInstanceStruct
  *chartInstance);
static void sf_gateway_c2_test_hill_sim(SFc2_test_hill_simInstanceStruct
  *chartInstance);
static void mdl_start_c2_test_hill_sim(SFc2_test_hill_simInstanceStruct
  *chartInstance);
static void c2_chartstep_c2_test_hill_sim(SFc2_test_hill_simInstanceStruct
  *chartInstance);
static void initSimStructsc2_test_hill_sim(SFc2_test_hill_simInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c2_b_theta, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_test_hill_simInstanceStruct
...
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[3]);
...
static real_T c2_norm(SFc2_test_hill_simInstanceStruct *chartInstance, real_T
                      c2_x[3]);
static real_T c2_eml_xnrm2(SFc2_test_hill_simInstanceStruct *chartInstance,
  real_T c2_x[3]);
static void c2_below_threshold(SFc2_test_hill_simInstanceStruct *chartInstance);
static real_T c2_mpower(SFc2_test_hill_simInstanceStruct *chartInstance, real_T
  c2_b_a);
static void c2_eml_scalar_eg(SFc2_test_hill_simInstanceStruct *chartInstance);
static void c2_cross(SFc2_test_hill_simInstanceStruct *chartInstance, real_T
                     c2_b_a[3], real_T c2_b[3], real_T c2_c[3]);
static void c2_rdivide(SFc2_test_hill_simInstanceStruct *chartInstance, real_T
  c2_x[3], real_T c2_y, real_T c2_z[3]);
static real_T c2_acos(SFc2_test_hill_simInstanceStruct *chartInstance, real_T
                      c2_x);
static void c2_eml_error(SFc2_test_hill_simInstanceStruct *chartInstance);
static real_T c2_dot(SFc2_test_hill_simInstanceStruct *chartInstance, real_T
                     c2_b_a[3], real_T c2_b[3]);
static real_T c2_eml_xdotc(SFc2_test_hill_simInstanceStruct *chartInstance,
  real_T c2_x[3], real_T c2_y[3]);
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_d_emlrt_marshallIn(SFc2_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_e_emlrt_marshallIn(SFc2_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_test_hill_sim, const char_T
  *c2_identifier);
static uint8_T c2_f_emlrt_marshallIn(SFc2_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_acos(SFc2_test_hill_simInstanceStruct *chartInstance, real_T
                      *c2_x);
static void init_dsm_address_info(SFc2_test_hill_simInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc2_test_hill_simInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_test_hill_sim = 0U;
}
  ...
  (SFc2_test_hill_simInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = *chartInstance->c2_OM;
  c2_u = c2_hoistedGlobal;
  c2_b_y = NULL;
  sf_mex_assign(&c2_b_y, sf_mex_create("y", &c2_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c2_y, 0, c2_b_y);
  c2_b_hoistedGlobal = *chartInstance->c2_a;
  c2_b_u = c2_b_hoistedGlobal;
  c2_c_y = NULL;
  sf_mex_assign(&c2_c_y, sf_mex_create("y", &c2_b_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c2_y, 1, c2_c_y);
  c2_c_hoistedGlobal = *chartInstance->c2_em;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  *chartInstance->c2_OM = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 0)), "OM");
  *chartInstance->c2_a = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 1)), "a");
  *chartInstance->c2_em = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 2)), "em");
  *chartInstance->c2_i = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 3)), "i");
  *chartInstance->c2_om = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 4)), "om");
  *chartInstance->c2_theta = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 5)), "theta");
  chartInstance->c2_is_active_c2_test_hill_sim = c2_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 6)),
     "is_active_c2_test_hill_sim");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_test_hill_sim(chartInstance);
  ...
  *chartInstance)
{
  ...
  for (c2_i0 = 0; c2_i0 < 3; c2_i0++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c2_r)[c2_i0], 0U);
  }

  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_test_hill_sim(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_test_hill_simMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_a, 1U);
  for (c2_i1 = 0; c2_i1 < 3; c2_i1++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c2_v)[c2_i1], 2U);
  }

  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_em, 3U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_i, 4U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_OM, 5U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_om, 6U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_theta, 7U);
}
  ...
  *chartInstance)
{
  ...
  real_T c2_d0;
  int32_T c2_i19;
  static real_T c2_c_a[3] = { 0.0, 0.0, 1.0 };

  int32_T c2_i20;
  static real_T c2_dv2[3] = { 0.0, 1.0, 0.0 };

  int32_T c2_i21;
  static real_T c2_dv3[3] = { 1.0, 0.0, 0.0 };
  ...
  for (c2_i2 = 0; c2_i2 < 3; c2_i2++) {
    c2_b_r[c2_i2] = (*chartInstance->c2_r)[c2_i2];
  }

  for (c2_i3 = 0; c2_i3 < 3; c2_i3++) {
    c2_b_v[c2_i3] = (*chartInstance->c2_v)[c2_i3];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 21U, 23U, c2_debug_family_names,
    c2_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_mu, 0U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_rm, 1U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_h, 3U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_hm, 4U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_l, 5U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_e, 6U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_kv, 7U, c2_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_jv, 8U, c2_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_iv, 9U, c2_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_n, 10U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_c_v, MAX_uint32_T, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_c_r, MAX_uint32_T, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 14U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_b_r, 12U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_b_v, 11U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_a, 15U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_em, 16U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_i, 17U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_OM, 18U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_om, 19U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_theta, 20U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  for (c2_i4 = 0; c2_i4 < 3; c2_i4++) {
    c2_d_r[c2_i4] = c2_c_r[c2_i4];
  }

  c2_rm = c2_norm(chartInstance, c2_d_r);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 11);
  for (c2_i5 = 0; c2_i5 < 3; c2_i5++) {
    c2_d_v[c2_i5] = c2_c_v[c2_i5];
  }

  c2_vm = c2_norm(chartInstance, c2_d_v);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 12);
  c2_B = c2_rm;
  c2_y = c2_B;
  c2_b_y = c2_y;
  c2_c_y = c2_b_y;
  c2_d_y = 7.9712E+14 / c2_c_y;
  c2_b_B = c2_d_y - c2_mpower(chartInstance, c2_vm);
  c2_e_y = c2_b_B;
  c2_f_y = c2_e_y;
  c2_g_y = c2_f_y;
  c2_b_a = 3.9856E+14 / c2_g_y;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 13);
  for (c2_i6 = 0; c2_i6 < 3; c2_i6++) {
    c2_e_r[c2_i6] = c2_c_r[c2_i6];
  }

  for (c2_i7 = 0; c2_i7 < 3; c2_i7++) {
    c2_e_v[c2_i7] = c2_c_v[c2_i7];
  }

  c2_cross(chartInstance, c2_e_r, c2_e_v, c2_dv0);
  for (c2_i8 = 0; c2_i8 < 3; c2_i8++) {
    c2_h[c2_i8] = c2_dv0[c2_i8];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 14);
  for (c2_i9 = 0; c2_i9 < 3; c2_i9++) {
    c2_b_h[c2_i9] = c2_h[c2_i9];
  }

  c2_hm = c2_norm(chartInstance, c2_b_h);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 15);
  for (c2_i10 = 0; c2_i10 < 3; c2_i10++) {
    c2_f_v[c2_i10] = c2_c_v[c2_i10];
  }

  for (c2_i11 = 0; c2_i11 < 3; c2_i11++) {
    c2_c_h[c2_i11] = c2_h[c2_i11];
  }

  c2_cross(chartInstance, c2_f_v, c2_c_h, c2_dv1);
  for (c2_i12 = 0; c2_i12 < 3; c2_i12++) {
    c2_l[c2_i12] = c2_dv1[c2_i12];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 16);
  for (c2_i13 = 0; c2_i13 < 3; c2_i13++) {
    c2_A[c2_i13] = c2_l[c2_i13];
  }
  ...
  c2_rdivide(chartInstance, c2_b_A, 3.9856E+14, c2_h_y);
  for (c2_i15 = 0; c2_i15 < 3; c2_i15++) {
    c2_A[c2_i15] = c2_c_r[c2_i15];
  }

  c2_c_B = c2_rm;
  for (c2_i16 = 0; c2_i16 < 3; c2_i16++) {
    c2_c_A[c2_i16] = c2_A[c2_i16];
  }

  c2_rdivide(chartInstance, c2_c_A, c2_c_B, c2_i_y);
  for (c2_i17 = 0; c2_i17 < 3; c2_i17++) {
    c2_e[c2_i17] = c2_h_y[c2_i17] - c2_i_y[c2_i17];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 17);
  for (c2_i18 = 0; c2_i18 < 3; c2_i18++) {
    c2_b_e[c2_i18] = c2_e[c2_i18];
  }

  c2_b_em = c2_norm(chartInstance, c2_b_e);
  ...
  c2_c_x = c2_b_x;
  c2_l_y = c2_k_y;
  c2_m_y = c2_c_x / c2_l_y;
  c2_d0 = c2_m_y;
  c2_b_acos(chartInstance, &c2_d0);
  c2_b_i = c2_d0;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 19);
  for (c2_i19 = 0; c2_i19 < 3; c2_i19++) {
    c2_kv[c2_i19] = c2_c_a[c2_i19];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 20);
  for (c2_i20 = 0; c2_i20 < 3; c2_i20++) {
    c2_jv[c2_i20] = c2_dv2[c2_i20];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 21);
  for (c2_i21 = 0; c2_i21 < 3; c2_i21++) {
    c2_iv[c2_i21] = c2_dv3[c2_i21];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 23);
  for (c2_i22 = 0; c2_i22 < 3; c2_i22++) {
    c2_A[c2_i22] = c2_h[c2_i22];
  }

  c2_c1 = 0.0 * c2_A[2] - c2_A[1];
  c2_c2 = c2_A[0] - 0.0 * c2_A[2];
  c2_c3 = 0.0 * c2_A[1] - 0.0 * c2_A[0];
  c2_h_y[0] = c2_c1;
  c2_h_y[1] = c2_c2;
  c2_h_y[2] = c2_c3;
  for (c2_i23 = 0; c2_i23 < 3; c2_i23++) {
    c2_n_y[c2_i23] = c2_h_y[c2_i23];
  }

  c2_d1 = c2_norm(chartInstance, c2_n_y);
  if (CV_EML_IF(0, 1, 0, CV_RELATIONAL_EVAL(4U, 0U, 0, c2_d1, 0.0, -1, 0U, c2_d1
        == 0.0))) {
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 24);
    for (c2_i24 = 0; c2_i24 < 3; c2_i24++) {
      c2_n[c2_i24] = c2_iv[c2_i24];
    }
  } else {
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 26);
    for (c2_i25 = 0; c2_i25 < 3; c2_i25++) {
      c2_A[c2_i25] = c2_h[c2_i25];
    }

    c2_b_c1 = 0.0 * c2_A[2] - c2_A[1];
    c2_b_c2 = c2_A[0] - 0.0 * c2_A[2];
    c2_b_c3 = 0.0 * c2_A[1] - 0.0 * c2_A[0];
    c2_h_y[0] = c2_b_c1;
    c2_h_y[1] = c2_b_c2;
    c2_h_y[2] = c2_b_c3;
    for (c2_i26 = 0; c2_i26 < 3; c2_i26++) {
      c2_A[c2_i26] = c2_h[c2_i26];
    }

    c2_c_c1 = 0.0 * c2_A[2] - c2_A[1];
    c2_c_c2 = c2_A[0] - 0.0 * c2_A[2];
    c2_c_c3 = 0.0 * c2_A[1] - 0.0 * c2_A[0];
    c2_A[0] = c2_c_c1;
    c2_A[1] = c2_c_c2;
    c2_A[2] = c2_c_c3;
    for (c2_i27 = 0; c2_i27 < 3; c2_i27++) {
      c2_e_A[c2_i27] = c2_A[c2_i27];
    }

    c2_o_y = c2_eml_xnrm2(chartInstance, c2_e_A);
    c2_e_B = c2_o_y;
    for (c2_i28 = 0; c2_i28 < 3; c2_i28++) {
      c2_p_y[c2_i28] = c2_h_y[c2_i28];
    }

    c2_rdivide(chartInstance, c2_p_y, c2_e_B, c2_dv4);
    for (c2_i29 = 0; c2_i29 < 3; c2_i29++) {
      c2_n[c2_i29] = c2_dv4[c2_i29];
    }
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 29);
  for (c2_i30 = 0; c2_i30 < 3; c2_i30++) {
    c2_b_n[c2_i30] = c2_n[c2_i30];
  }

  for (c2_i31 = 0; c2_i31 < 3; c2_i31++) {
    c2_dv5[c2_i31] = c2_dv2[c2_i31];
  }

  c2_d2 = c2_dot(chartInstance, c2_b_n, c2_dv5);
  if (CV_EML_IF(0, 1, 1, CV_RELATIONAL_EVAL(4U, 0U, 1, c2_d2, 0.0, -1, 4U, c2_d2
        > 0.0))) {
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 30);
    for (c2_i32 = 0; c2_i32 < 3; c2_i32++) {
      c2_c_n[c2_i32] = c2_n[c2_i32];
    }

    for (c2_i33 = 0; c2_i33 < 3; c2_i33++) {
      c2_dv6[c2_i33] = c2_dv3[c2_i33];
    }

    c2_d_x = c2_dot(chartInstance, c2_c_n, c2_dv6);
    c2_b_OM = c2_d_x;
    guard8 = false;
    if (c2_b_OM < -1.0) {
      guard8 = true;
    ...
    c2_e_x = c2_b_OM;
    c2_b_OM = c2_e_x;
    c2_b_OM = muDoubleScalarAcos(c2_b_OM);
  } else {
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 32);
    for (c2_i34 = 0; c2_i34 < 3; c2_i34++) {
      c2_d_n[c2_i34] = c2_n[c2_i34];
    }

    for (c2_i35 = 0; c2_i35 < 3; c2_i35++) {
      c2_dv7[c2_i35] = c2_dv3[c2_i35];
    }

    c2_f_x = c2_dot(chartInstance, c2_d_n, c2_dv7);
    c2_g_x = c2_f_x;
    guard7 = false;
    if (c2_g_x < -1.0) {
      guard7 = true;
    ...
    c2_g_x = muDoubleScalarAcos(c2_g_x);
    c2_b_OM = 6.2831853071795862 - c2_g_x;
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 35);
  if (CV_EML_IF(0, 1, 2, CV_RELATIONAL_EVAL(4U, 0U, 2, c2_b_em, 0.0, -1, 0U,
        c2_b_em == 0.0))) {
    ...
    for (c2_i36 = 0; c2_i36 < 3; c2_i36++) {
      c2_c_e[c2_i36] = c2_e[c2_i36];
    }

    for (c2_i37 = 0; c2_i37 < 3; c2_i37++) {
      c2_d_a[c2_i37] = c2_c_a[c2_i37];
    }

    c2_d3 = c2_dot(chartInstance, c2_c_e, c2_d_a);
    if (CV_EML_IF(0, 1, 3, CV_RELATIONAL_EVAL(4U, 0U, 3, c2_d3, 0.0, -1, 4U,
          c2_d3 > 0.0))) {
      _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 41);
      for (c2_i38 = 0; c2_i38 < 3; c2_i38++) {
        c2_e_n[c2_i38] = c2_n[c2_i38];
      }

      for (c2_i39 = 0; c2_i39 < 3; c2_i39++) {
        c2_d_e[c2_i39] = c2_e[c2_i39];
      }

      c2_f_A = c2_dot(chartInstance, c2_e_n, c2_d_e);
      c2_f_B = c2_b_em;
      c2_h_x = c2_f_A;
      c2_q_y = c2_f_B;
      c2_i_x = c2_h_x;
      ...
      for (c2_i40 = 0; c2_i40 < 3; c2_i40++) {
        c2_f_n[c2_i40] = c2_n[c2_i40];
      }

      for (c2_i41 = 0; c2_i41 < 3; c2_i41++) {
        c2_e_e[c2_i41] = c2_e[c2_i41];
      }

      c2_g_A = c2_dot(chartInstance, c2_f_n, c2_e_e);
      c2_g_B = c2_b_em;
      c2_m_x = c2_g_A;
      c2_u_y = c2_g_B;
      c2_n_x = c2_m_x;
      ...
      c2_q_x = muDoubleScalarAcos(c2_q_x);
      c2_b_om = 6.2831853071795862 - c2_q_x;
    }
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 47);
  if (CV_EML_IF(0, 1, 4, CV_RELATIONAL_EVAL(4U, 0U, 4, c2_b_em, 0.0, -1, 0U,
        c2_b_em == 0.0))) {
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 49);
    for (c2_i42 = 0; c2_i42 < 3; c2_i42++) {
      c2_A[c2_i42] = c2_c_r[c2_i42];
    }

    c2_h_B = c2_rm;
    for (c2_i43 = 0; c2_i43 < 3; c2_i43++) {
      c2_h_A[c2_i43] = c2_A[c2_i43];
    }

    c2_rdivide(chartInstance, c2_h_A, c2_h_B, c2_h_y);
    for (c2_i44 = 0; c2_i44 < 3; c2_i44++) {
      c2_y_y[c2_i44] = c2_h_y[c2_i44];
    }

    for (c2_i45 = 0; c2_i45 < 3; c2_i45++) {
      c2_dv8[c2_i45] = c2_dv3[c2_i45];
    }

    c2_r_x = c2_dot(chartInstance, c2_y_y, c2_dv8);
    c2_b_theta = c2_r_x;
    guard4 = false;
    if (c2_b_theta < -1.0) {
      guard4 = true;
    ...
    c2_s_x = c2_b_theta;
    c2_b_theta = c2_s_x;
    c2_b_theta = muDoubleScalarAcos(c2_b_theta);
  } else {
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 53);
    if (CV_EML_IF(0, 1, 5, CV_RELATIONAL_EVAL(4U, 0U, 5, c2_b_em, 1.0E-7, -1, 2U,
          c2_b_em < 1.0E-7))) {
      _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 54);
      for (c2_i46 = 0; c2_i46 < 3; c2_i46++) {
        c2_f_r[c2_i46] = c2_c_r[c2_i46];
      }

      c2_rdivide(chartInstance, c2_f_r, c2_rm, c2_A);
      for (c2_i47 = 0; c2_i47 < 3; c2_i47++) {
        c2_i_A[c2_i47] = c2_A[c2_i47];
      }

      for (c2_i48 = 0; c2_i48 < 3; c2_i48++) {
        c2_dv9[c2_i48] = c2_dv3[c2_i48];
      }

      c2_t_x = c2_dot(chartInstance, c2_i_A, c2_dv9);
      c2_b_theta = c2_t_x;
      guard3 = false;
      if (c2_b_theta < -1.0) {
        guard3 = true;
      ...
      for (c2_i49 = 0; c2_i49 < 3; c2_i49++) {
        c2_g_r[c2_i49] = c2_c_r[c2_i49];
      }

      for (c2_i50 = 0; c2_i50 < 3; c2_i50++) {
        c2_g_v[c2_i50] = c2_c_v[c2_i50];
      }

      c2_d4 = c2_dot(chartInstance, c2_g_r, c2_g_v);
      if (CV_EML_IF(0, 1, 6, CV_RELATIONAL_EVAL(4U, 0U, 6, c2_d4, 0.0, -1, 4U,
            c2_d4 > 0.0))) {
        _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 59);
        for (c2_i51 = 0; c2_i51 < 3; c2_i51++) {
          c2_h_r[c2_i51] = c2_c_r[c2_i51];
        }

        for (c2_i52 = 0; c2_i52 < 3; c2_i52++) {
          c2_f_e[c2_i52] = c2_e[c2_i52];
        }

        c2_j_A = c2_dot(chartInstance, c2_h_r, c2_f_e);
        c2_i_B = c2_rm * c2_b_em;
        c2_v_x = c2_j_A;
        c2_ab_y = c2_i_B;
        c2_w_x = c2_v_x;
        c2_bb_y = c2_ab_y;
        ...
        for (c2_i53 = 0; c2_i53 < 3; c2_i53++) {
          c2_i_r[c2_i53] = c2_c_r[c2_i53];
        }

        for (c2_i54 = 0; c2_i54 < 3; c2_i54++) {
          c2_g_e[c2_i54] = c2_e[c2_i54];
        }

        c2_k_A = c2_dot(chartInstance, c2_i_r, c2_g_e);
        c2_j_B = c2_rm * c2_b_em;
        c2_bb_x = c2_k_A;
        c2_eb_y = c2_j_B;
        c2_cb_x = c2_bb_x;
        c2_fb_y = c2_eb_y;
        ...
        c2_fb_x = muDoubleScalarAcos(c2_fb_x);
        c2_b_theta = 6.2831853071795862 - c2_fb_x;
      }
    }
  }
  ...
  *chartInstance->c2_em = c2_b_em;
  *chartInstance->c2_i = c2_b_i;
  *chartInstance->c2_OM = c2_b_OM;
  *chartInstance->c2_om = c2_b_om;
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_test_hill_simInstanceStruct *chartInstance;
  chartInstance = (SFc2_test_hill_simInstanceStruct *)chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c2_b_theta, const char_T *c2_identifier)
{
  ...
  c2_y = c2_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_b_theta), &c2_thisId);
...
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  const mxArray *c2_b_theta;
  const char_T *c2_identifier;
  emlrtMsgIdentifier c2_thisId;
  real_T c2_y;
  SFc2_test_hill_simInstanceStruct *chartInstance;
  chartInstance = (SFc2_test_hill_simInstanceStruct *)chartInstanceVoid;
  c2_b_theta = sf_mex_dup(c2_mxArrayInData);
  ...
  *c2_inData)
{
  ...
  for (c2_i57 = 0; c2_i57 < 3; c2_i57++) {
    c2_b_inData[c2_i57] = (*(real_T (*)[3])c2_inData)[c2_i57];
  }
...
const mxArray *sf_c2_test_hill_sim_get_eml_resolved_functions_info(void)
{
  const mxArray *c2_nameCaptureInfo = NULL;
  c2_nameCaptureInfo = NULL;
  sf_mex_assign(&c2_nameCaptureInfo, sf_mex_createstruct("structure", 2, 71, 1),
                false);
...
static void c2_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 21);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("intmin"), "name", "name", 21);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 21);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "context",
                  "context", 28);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("rdivide"), "name", "name", 28);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 28);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("mpower"), "name", "name", 33);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 33);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 35);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("ismatrix"), "name", "name", 35);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 35);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 36);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("power"), "name", "name", 36);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 36);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m!fltpower"), "context",
                  "context", 42);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("floor"), "name", "name", 42);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 42);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("cross"), "name", "name", 46);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 46);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("acos"), "name", "name", 47);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 47);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/acos.m"), "resolved",
                  "resolved", 47);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1395328492U), "fileTimeLo",
                  "fileTimeLo", 47);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 47);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("dot"), "name", "name", 50);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 50);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/specfun/dot.m"), "context",
                  "context", 51);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("isequal"), "name", "name", 51);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 51);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
...
static void c2_b_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("rdivide"), "name", "name", 70);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 70);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "resolved",
                     ...
                     c2_b_a[3], real_T c2_b[3], real_T c2_c[3])
{
  ...
  real_T c2_c3;
  (void)chartInstance;
  c2_c1 = c2_b_a[1] * c2_b[2] - c2_b_a[2] * c2_b[1];
  c2_c2 = c2_b_a[2] * c2_b[0] - c2_b_a[0] * c2_b[2];
  c2_c3 = c2_b_a[0] * c2_b[1] - c2_b_a[1] * c2_b[0];
  c2_c[0] = c2_c1;
  c2_c[1] = c2_c2;
  c2_c[2] = c2_c3;
}
  ...
  c2_x[3], real_T c2_y, real_T c2_z[3])
{
  ...
  for (c2_i62 = 0; c2_i62 < 3; c2_i62++) {
    c2_z[c2_i62] = c2_x[c2_i62] / c2_c_y;
  }
}
                      ...
                      c2_x)
{
  real_T c2_b_x;
  c2_b_x = c2_x;
  c2_b_acos(chartInstance, &c2_b_x);
  return c2_b_x;
}
                     ...
                     c2_b_a[3], real_T c2_b[3])
{
  ...
  for (c2_i65 = 0; c2_i65 < 3; c2_i65++) {
    c2_c_a[c2_i65] = c2_b_a[c2_i65];
  }

  for (c2_i66 = 0; c2_i66 < 3; c2_i66++) {
    c2_b_b[c2_i66] = c2_b[c2_i66];
  }

  return c2_eml_xdotc(chartInstance, c2_c_a, c2_b_b);
}
  ...
  real_T c2_x[3], real_T c2_y[3])
{
  ...
  for (c2_k = 1; c2_k < 4; c2_k++) {
    ...
    c2_d += c2_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
      (real_T)c2_b_k), 1, 3, 1, 0) - 1] * c2_y[_SFD_EML_ARRAY_BOUNDS_CHECK("",
  ...
  *c2_identifier)
{
  ...
  c2_y = c2_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_test_hill_sim), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_test_hill_sim);
  return c2_y;
}
...
static void init_simulink_io_address(SFc2_test_hill_simInstanceStruct
  *chartInstance)
{
  chartInstance->c2_r = (real_T (*)[3])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c2_a = (real_T *)ssGetOutputPortSignal_wrapper(chartInstance->S,
    1);
  chartInstance->c2_v = (real_T (*)[3])ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c2_em = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 2);
  chartInstance->c2_i = (real_T *)ssGetOutputPortSignal_wrapper(chartInstance->S,
    3);
  chartInstance->c2_OM = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 4);
  chartInstance->c2_om = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 5);
...
void sf_c2_test_hill_sim_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4043842589U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1361924153U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2694888760U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2289729038U);
}

mxArray* sf_c2_test_hill_sim_get_post_codegen_info(void);
mxArray *sf_c2_test_hill_sim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("dSxiyxhoC9B9ZPxT5r1FL");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c2_test_hill_sim_get_post_codegen_info();
...
mxArray *sf_c2_test_hill_sim_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_test_hill_sim_jit_fallback_info(void)
{
...
mxArray *sf_c2_test_hill_sim_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_test_hill_sim(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[9],T\"OM\",},{M[1],M[5],T\"a\",},{M[1],M[7],T\"em\",},{M[1],M[8],T\"i\",},{M[1],M[10],T\"om\",},{M[1],M[11],T\"theta\",},{M[8],M[0],T\"is_active_c2_test_hill_sim\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 7, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_test_hill_sim_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_test_hill_simInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(3,2,0,1,"em");
          _SFD_SET_DATA_PROPS(4,2,0,1,"i");
          _SFD_SET_DATA_PROPS(5,2,0,1,"OM");
          _SFD_SET_DATA_PROPS(6,2,0,1,"om");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,847);
        _SFD_CV_INIT_EML_IF(0,1,0,286,309,318,359);
        _SFD_CV_INIT_EML_IF(0,1,1,365,379,412,457);
        _SFD_CV_INIT_EML_IF(0,1,2,459,467,482,596);
        _SFD_CV_INIT_EML_IF(0,1,3,496,510,545,592);
        _SFD_CV_INIT_EML_IF(0,1,4,598,606,644,841);
        _SFD_CV_INIT_EML_IF(0,1,5,658,670,710,837);
        _SFD_CV_INIT_EML_IF(0,1,6,720,733,776,831);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,0,289,309,-1,0);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,1,368,379,-1,4);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,2,462,467,-1,0);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,3,499,510,-1,4);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,4,601,606,-1,0);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,5,661,670,-1,2);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,6,723,733,-1,4);
        ...
        _SFD_SET_DATA_VALUE_PTR(2U, *chartInstance->c2_v);
        _SFD_SET_DATA_VALUE_PTR(3U, chartInstance->c2_em);
        _SFD_SET_DATA_VALUE_PTR(4U, chartInstance->c2_i);
        _SFD_SET_DATA_VALUE_PTR(5U, chartInstance->c2_OM);
        _SFD_SET_DATA_VALUE_PTR(6U, chartInstance->c2_om);
        _SFD_SET_DATA_VALUE_PTR(7U, chartInstance->c2_theta);
      }
    } else {
...
{
  return "ZUpMNVlLLORUYOllxMRgfF";
}

static void sf_opaque_initialize_c2_test_hill_sim(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_test_hill_simInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_test_hill_sim((SFc2_test_hill_simInstanceStruct*)
    chartInstanceVar);
  initialize_c2_test_hill_sim((SFc2_test_hill_simInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_test_hill_sim(void *chartInstanceVar)
{
  enable_c2_test_hill_sim((SFc2_test_hill_simInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_test_hill_sim(void *chartInstanceVar)
{
  disable_c2_test_hill_sim((SFc2_test_hill_simInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_test_hill_sim(void *chartInstanceVar)
{
  sf_gateway_c2_test_hill_sim((SFc2_test_hill_simInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_test_hill_sim(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c2_test_hill_sim((SFc2_test_hill_simInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_test_hill_sim(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c2_test_hill_sim((SFc2_test_hill_simInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c2_test_hill_sim(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_test_hill_simInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_test_hill_sim((SFc2_test_hill_simInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_test_hill_sim((SFc2_test_hill_simInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_test_hill_sim(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_test_hill_sim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3056046164U));
  ssSetChecksum1(S,(3307150646U));
  ssSetChecksum2(S,(1837933950U));
  ssSetChecksum3(S,(3084327395U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_test_hill_sim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_test_hill_sim(SimStruct *S)
{
  SFc2_test_hill_simInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_test_hill_simInstanceStruct *)utMalloc(sizeof
    (SFc2_test_hill_simInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_test_hill_simInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_test_hill_sim;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_test_hill_sim;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_test_hill_sim;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_test_hill_sim;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_test_hill_sim;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_test_hill_sim;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_test_hill_sim;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_test_hill_sim;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_test_hill_sim;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_test_hill_sim;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_test_hill_sim;
...
void c2_test_hill_sim_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_test_hill_sim(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_test_hill_sim(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_test_hill_sim(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_test_hill_sim_method_dispatcher.\n"
