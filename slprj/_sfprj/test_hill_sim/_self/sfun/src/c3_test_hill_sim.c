...
static const char * c3_debug_family_names[21] = { "mu", "rm", "vm", "h", "hm",
  "l", "e", "kv", "jv", "iv", "n", "v", "r", "nargin", "nargout", "a", "em", "i",
  "OM", "om", "theta" };

/* Function Declarations */
static void initialize_c3_test_hill_sim(SFc3_test_hill_simInstanceStruct
  *chartInstance);
static void initialize_params_c3_test_hill_sim(SFc3_test_hill_simInstanceStruct *
  chartInstance);
static void enable_c3_test_hill_sim(SFc3_test_hill_simInstanceStruct
  *chartInstance);
static void disable_c3_test_hill_sim(SFc3_test_hill_simInstanceStruct
  *chartInstance);
static void c3_update_debugger_state_c3_test_hill_sim
  (SFc3_test_hill_simInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_test_hill_sim
  (SFc3_test_hill_simInstanceStruct *chartInstance);
static void set_sim_state_c3_test_hill_sim(SFc3_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c3_st);
static void finalize_c3_test_hill_sim(SFc3_test_hill_simInstanceStruct
  *chartInstance);
static void sf_gateway_c3_test_hill_sim(SFc3_test_hill_simInstanceStruct
  *chartInstance);
static void mdl_start_c3_test_hill_sim(SFc3_test_hill_simInstanceStruct
  *chartInstance);
static void c3_chartstep_c3_test_hill_sim(SFc3_test_hill_simInstanceStruct
  *chartInstance);
static void initSimStructsc3_test_hill_sim(SFc3_test_hill_simInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c3_b_theta, const char_T *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_test_hill_simInstanceStruct
...
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_c_emlrt_marshallIn(SFc3_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[3]);
...
static real_T c3_norm(SFc3_test_hill_simInstanceStruct *chartInstance, real_T
                      c3_x[3]);
static real_T c3_eml_xnrm2(SFc3_test_hill_simInstanceStruct *chartInstance,
  real_T c3_x[3]);
static void c3_below_threshold(SFc3_test_hill_simInstanceStruct *chartInstance);
static real_T c3_mpower(SFc3_test_hill_simInstanceStruct *chartInstance, real_T
  c3_b_a);
static void c3_eml_scalar_eg(SFc3_test_hill_simInstanceStruct *chartInstance);
static void c3_cross(SFc3_test_hill_simInstanceStruct *chartInstance, real_T
                     c3_b_a[3], real_T c3_b[3], real_T c3_c[3]);
static void c3_rdivide(SFc3_test_hill_simInstanceStruct *chartInstance, real_T
  c3_x[3], real_T c3_y, real_T c3_z[3]);
static real_T c3_acos(SFc3_test_hill_simInstanceStruct *chartInstance, real_T
                      c3_x);
static void c3_eml_error(SFc3_test_hill_simInstanceStruct *chartInstance);
static real_T c3_dot(SFc3_test_hill_simInstanceStruct *chartInstance, real_T
                     c3_b_a[3], real_T c3_b[3]);
static real_T c3_eml_xdotc(SFc3_test_hill_simInstanceStruct *chartInstance,
  real_T c3_x[3], real_T c3_y[3]);
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_d_emlrt_marshallIn(SFc3_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_e_emlrt_marshallIn(SFc3_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_test_hill_sim, const char_T
  *c3_identifier);
static uint8_T c3_f_emlrt_marshallIn(SFc3_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_acos(SFc3_test_hill_simInstanceStruct *chartInstance, real_T
                      *c3_x);
static void init_dsm_address_info(SFc3_test_hill_simInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc3_test_hill_simInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_test_hill_sim = 0U;
}
  ...
  (SFc3_test_hill_simInstanceStruct *chartInstance)
{
  ...
  c3_hoistedGlobal = *chartInstance->c3_OM;
  ...
  c3_c_hoistedGlobal = *chartInstance->c3_em;
  ...
  c3_e_hoistedGlobal = *chartInstance->c3_om;
  ...
  c3_g_hoistedGlobal = chartInstance->c3_is_active_c3_test_hill_sim;
  ...
  *chartInstance, const mxArray *c3_st)
{
  ...
  *chartInstance->c3_OM = c3_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 0)), "OM");
  *chartInstance->c3_a = c3_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 1)), "a");
  *chartInstance->c3_em = c3_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 2)), "em");
  *chartInstance->c3_i = c3_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 3)), "i");
  *chartInstance->c3_om = c3_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 4)), "om");
  *chartInstance->c3_theta = c3_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 5)), "theta");
  chartInstance->c3_is_active_c3_test_hill_sim = c3_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 6)),
     "is_active_c3_test_hill_sim");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_test_hill_sim(chartInstance);
  ...
  *chartInstance)
{
  ...
  for (c3_i0 = 0; c3_i0 < 3; c3_i0++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c3_r)[c3_i0], 0U);
  }

  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_test_hill_sim(chartInstance);
  ...
  for (c3_i1 = 0; c3_i1 < 3; c3_i1++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c3_v)[c3_i1], 2U);
  }

  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_em, 3U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_i, 4U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_OM, 5U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_om, 6U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_theta, 7U);
}
  ...
  *chartInstance)
{
  ...
  real_T c3_d0;
  int32_T c3_i19;
  static real_T c3_c_a[3] = { 0.0, 0.0, 1.0 };

  int32_T c3_i20;
  static real_T c3_dv2[3] = { 0.0, 1.0, 0.0 };

  int32_T c3_i21;
  static real_T c3_dv3[3] = { 1.0, 0.0, 0.0 };
  ...
  for (c3_i2 = 0; c3_i2 < 3; c3_i2++) {
    c3_b_r[c3_i2] = (*chartInstance->c3_r)[c3_i2];
  }

  for (c3_i3 = 0; c3_i3 < 3; c3_i3++) {
    c3_b_v[c3_i3] = (*chartInstance->c3_v)[c3_i3];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 21U, 23U, c3_debug_family_names,
    c3_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_mu, 0U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_rm, 1U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_vm, 2U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_h, 3U, c3_c_sf_marshallOut,
    c3_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_hm, 4U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_l, 5U, c3_c_sf_marshallOut,
    c3_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_e, 6U, c3_c_sf_marshallOut,
    c3_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c3_kv, 7U, c3_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c3_jv, 8U, c3_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c3_iv, 9U, c3_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_n, 10U, c3_c_sf_marshallOut,
    c3_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_c_v, MAX_uint32_T, c3_c_sf_marshallOut,
    c3_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_c_r, MAX_uint32_T, c3_c_sf_marshallOut,
    c3_b_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_nargout, 14U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c3_b_r, 12U, c3_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c3_b_v, 11U, c3_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_a, 15U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_em, 16U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_i, 17U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_OM, 18U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_om, 19U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_theta, 20U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  for (c3_i4 = 0; c3_i4 < 3; c3_i4++) {
    c3_d_r[c3_i4] = c3_c_r[c3_i4];
  }

  c3_rm = c3_norm(chartInstance, c3_d_r);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 11);
  for (c3_i5 = 0; c3_i5 < 3; c3_i5++) {
    c3_d_v[c3_i5] = c3_c_v[c3_i5];
  }

  c3_vm = c3_norm(chartInstance, c3_d_v);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 12);
  c3_B = c3_rm;
  c3_y = c3_B;
  c3_b_y = c3_y;
  c3_c_y = c3_b_y;
  c3_d_y = 7.9712E+14 / c3_c_y;
  c3_b_B = c3_d_y - c3_mpower(chartInstance, c3_vm);
  c3_e_y = c3_b_B;
  c3_f_y = c3_e_y;
  c3_g_y = c3_f_y;
  c3_b_a = 3.9856E+14 / c3_g_y;
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 13);
  for (c3_i6 = 0; c3_i6 < 3; c3_i6++) {
    c3_e_r[c3_i6] = c3_c_r[c3_i6];
  }

  for (c3_i7 = 0; c3_i7 < 3; c3_i7++) {
    c3_e_v[c3_i7] = c3_c_v[c3_i7];
  }

  c3_cross(chartInstance, c3_e_r, c3_e_v, c3_dv0);
  for (c3_i8 = 0; c3_i8 < 3; c3_i8++) {
    c3_h[c3_i8] = c3_dv0[c3_i8];
  }

  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 14);
  for (c3_i9 = 0; c3_i9 < 3; c3_i9++) {
    c3_b_h[c3_i9] = c3_h[c3_i9];
  }

  c3_hm = c3_norm(chartInstance, c3_b_h);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 15);
  for (c3_i10 = 0; c3_i10 < 3; c3_i10++) {
    c3_f_v[c3_i10] = c3_c_v[c3_i10];
  }

  for (c3_i11 = 0; c3_i11 < 3; c3_i11++) {
    c3_c_h[c3_i11] = c3_h[c3_i11];
  }

  c3_cross(chartInstance, c3_f_v, c3_c_h, c3_dv1);
  for (c3_i12 = 0; c3_i12 < 3; c3_i12++) {
    c3_l[c3_i12] = c3_dv1[c3_i12];
  }

  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 16);
  for (c3_i13 = 0; c3_i13 < 3; c3_i13++) {
    c3_A[c3_i13] = c3_l[c3_i13];
  }

  for (c3_i14 = 0; c3_i14 < 3; c3_i14++) {
    c3_b_A[c3_i14] = c3_A[c3_i14];
  }

  c3_rdivide(chartInstance, c3_b_A, 3.9856E+14, c3_h_y);
  for (c3_i15 = 0; c3_i15 < 3; c3_i15++) {
    c3_A[c3_i15] = c3_c_r[c3_i15];
  }

  c3_c_B = c3_rm;
  for (c3_i16 = 0; c3_i16 < 3; c3_i16++) {
    c3_c_A[c3_i16] = c3_A[c3_i16];
  }

  c3_rdivide(chartInstance, c3_c_A, c3_c_B, c3_i_y);
  for (c3_i17 = 0; c3_i17 < 3; c3_i17++) {
    c3_e[c3_i17] = c3_h_y[c3_i17] - c3_i_y[c3_i17];
  }

  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 17);
  for (c3_i18 = 0; c3_i18 < 3; c3_i18++) {
    c3_b_e[c3_i18] = c3_e[c3_i18];
  }

  c3_b_em = c3_norm(chartInstance, c3_b_e);
  ...
  c3_c_x = c3_b_x;
  c3_l_y = c3_k_y;
  c3_m_y = c3_c_x / c3_l_y;
  c3_d0 = c3_m_y;
  c3_b_acos(chartInstance, &c3_d0);
  c3_b_i = c3_d0;
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 19);
  for (c3_i19 = 0; c3_i19 < 3; c3_i19++) {
    c3_kv[c3_i19] = c3_c_a[c3_i19];
  }

  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 20);
  for (c3_i20 = 0; c3_i20 < 3; c3_i20++) {
    c3_jv[c3_i20] = c3_dv2[c3_i20];
  }

  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 21);
  for (c3_i21 = 0; c3_i21 < 3; c3_i21++) {
    c3_iv[c3_i21] = c3_dv3[c3_i21];
  }

  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 23);
  for (c3_i22 = 0; c3_i22 < 3; c3_i22++) {
    c3_A[c3_i22] = c3_h[c3_i22];
  }

  c3_c1 = 0.0 * c3_A[2] - c3_A[1];
  c3_c2 = c3_A[0] - 0.0 * c3_A[2];
  c3_c3 = 0.0 * c3_A[1] - 0.0 * c3_A[0];
  c3_h_y[0] = c3_c1;
  c3_h_y[1] = c3_c2;
  c3_h_y[2] = c3_c3;
  for (c3_i23 = 0; c3_i23 < 3; c3_i23++) {
    c3_n_y[c3_i23] = c3_h_y[c3_i23];
  }

  c3_d1 = c3_norm(chartInstance, c3_n_y);
  if (CV_EML_IF(0, 1, 0, CV_RELATIONAL_EVAL(4U, 0U, 0, c3_d1, 0.0, -1, 0U, c3_d1
        == 0.0))) {
    _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 24);
    for (c3_i24 = 0; c3_i24 < 3; c3_i24++) {
      c3_n[c3_i24] = c3_iv[c3_i24];
    }
  } else {
    _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 26);
    for (c3_i25 = 0; c3_i25 < 3; c3_i25++) {
      c3_A[c3_i25] = c3_h[c3_i25];
    }

    c3_b_c1 = 0.0 * c3_A[2] - c3_A[1];
    c3_b_c2 = c3_A[0] - 0.0 * c3_A[2];
    c3_b_c3 = 0.0 * c3_A[1] - 0.0 * c3_A[0];
    c3_h_y[0] = c3_b_c1;
    c3_h_y[1] = c3_b_c2;
    c3_h_y[2] = c3_b_c3;
    for (c3_i26 = 0; c3_i26 < 3; c3_i26++) {
      c3_A[c3_i26] = c3_h[c3_i26];
    }

    c3_c_c1 = 0.0 * c3_A[2] - c3_A[1];
    c3_c_c2 = c3_A[0] - 0.0 * c3_A[2];
    c3_c_c3 = 0.0 * c3_A[1] - 0.0 * c3_A[0];
    c3_A[0] = c3_c_c1;
    c3_A[1] = c3_c_c2;
    c3_A[2] = c3_c_c3;
    for (c3_i27 = 0; c3_i27 < 3; c3_i27++) {
      c3_e_A[c3_i27] = c3_A[c3_i27];
    }

    c3_o_y = c3_eml_xnrm2(chartInstance, c3_e_A);
    c3_e_B = c3_o_y;
    for (c3_i28 = 0; c3_i28 < 3; c3_i28++) {
      c3_p_y[c3_i28] = c3_h_y[c3_i28];
    }

    c3_rdivide(chartInstance, c3_p_y, c3_e_B, c3_dv4);
    for (c3_i29 = 0; c3_i29 < 3; c3_i29++) {
      c3_n[c3_i29] = c3_dv4[c3_i29];
    }
  }

  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 29);
  for (c3_i30 = 0; c3_i30 < 3; c3_i30++) {
    c3_b_n[c3_i30] = c3_n[c3_i30];
  }

  for (c3_i31 = 0; c3_i31 < 3; c3_i31++) {
    c3_dv5[c3_i31] = c3_dv2[c3_i31];
  }

  c3_d2 = c3_dot(chartInstance, c3_b_n, c3_dv5);
  if (CV_EML_IF(0, 1, 1, CV_RELATIONAL_EVAL(4U, 0U, 1, c3_d2, 0.0, -1, 4U, c3_d2
        > 0.0))) {
    _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 30);
    for (c3_i32 = 0; c3_i32 < 3; c3_i32++) {
      c3_c_n[c3_i32] = c3_n[c3_i32];
    }

    for (c3_i33 = 0; c3_i33 < 3; c3_i33++) {
      c3_dv6[c3_i33] = c3_dv3[c3_i33];
    }

    c3_d_x = c3_dot(chartInstance, c3_c_n, c3_dv6);
    c3_b_OM = c3_d_x;
    guard8 = false;
    if (c3_b_OM < -1.0) {
      guard8 = true;
    ...
    c3_e_x = c3_b_OM;
    c3_b_OM = c3_e_x;
    c3_b_OM = muDoubleScalarAcos(c3_b_OM);
  } else {
    _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 32);
    for (c3_i34 = 0; c3_i34 < 3; c3_i34++) {
      c3_d_n[c3_i34] = c3_n[c3_i34];
    }

    for (c3_i35 = 0; c3_i35 < 3; c3_i35++) {
      c3_dv7[c3_i35] = c3_dv3[c3_i35];
    }

    c3_f_x = c3_dot(chartInstance, c3_d_n, c3_dv7);
    c3_g_x = c3_f_x;
    guard7 = false;
    if (c3_g_x < -1.0) {
      guard7 = true;
    ...
    c3_g_x = muDoubleScalarAcos(c3_g_x);
    c3_b_OM = 6.2831853071795862 - c3_g_x;
  }

  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 35);
  if (CV_EML_IF(0, 1, 2, CV_RELATIONAL_EVAL(4U, 0U, 2, c3_b_em, 0.0, -1, 0U,
        c3_b_em == 0.0))) {
    ...
    for (c3_i36 = 0; c3_i36 < 3; c3_i36++) {
      c3_c_e[c3_i36] = c3_e[c3_i36];
    }

    for (c3_i37 = 0; c3_i37 < 3; c3_i37++) {
      c3_d_a[c3_i37] = c3_c_a[c3_i37];
    }

    c3_d3 = c3_dot(chartInstance, c3_c_e, c3_d_a);
    if (CV_EML_IF(0, 1, 3, CV_RELATIONAL_EVAL(4U, 0U, 3, c3_d3, 0.0, -1, 4U,
          c3_d3 > 0.0))) {
      _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 41);
      for (c3_i38 = 0; c3_i38 < 3; c3_i38++) {
        c3_e_n[c3_i38] = c3_n[c3_i38];
      }

      for (c3_i39 = 0; c3_i39 < 3; c3_i39++) {
        c3_d_e[c3_i39] = c3_e[c3_i39];
      }

      c3_f_A = c3_dot(chartInstance, c3_e_n, c3_d_e);
      c3_f_B = c3_b_em;
      c3_h_x = c3_f_A;
      c3_q_y = c3_f_B;
      c3_i_x = c3_h_x;
      ...
      for (c3_i40 = 0; c3_i40 < 3; c3_i40++) {
        c3_f_n[c3_i40] = c3_n[c3_i40];
      }

      for (c3_i41 = 0; c3_i41 < 3; c3_i41++) {
        c3_e_e[c3_i41] = c3_e[c3_i41];
      }

      c3_g_A = c3_dot(chartInstance, c3_f_n, c3_e_e);
      c3_g_B = c3_b_em;
      c3_m_x = c3_g_A;
      c3_u_y = c3_g_B;
      c3_n_x = c3_m_x;
      ...
      c3_q_x = muDoubleScalarAcos(c3_q_x);
      c3_b_om = 6.2831853071795862 - c3_q_x;
    }
  }

  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 47);
  if (CV_EML_IF(0, 1, 4, CV_RELATIONAL_EVAL(4U, 0U, 4, c3_b_em, 0.0, -1, 0U,
        c3_b_em == 0.0))) {
    _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 49);
    for (c3_i42 = 0; c3_i42 < 3; c3_i42++) {
      c3_A[c3_i42] = c3_c_r[c3_i42];
    }

    c3_h_B = c3_rm;
    for (c3_i43 = 0; c3_i43 < 3; c3_i43++) {
      c3_h_A[c3_i43] = c3_A[c3_i43];
    }

    c3_rdivide(chartInstance, c3_h_A, c3_h_B, c3_h_y);
    for (c3_i44 = 0; c3_i44 < 3; c3_i44++) {
      c3_y_y[c3_i44] = c3_h_y[c3_i44];
    }

    for (c3_i45 = 0; c3_i45 < 3; c3_i45++) {
      c3_dv8[c3_i45] = c3_dv3[c3_i45];
    }

    c3_r_x = c3_dot(chartInstance, c3_y_y, c3_dv8);
    c3_b_theta = c3_r_x;
    guard4 = false;
    if (c3_b_theta < -1.0) {
      guard4 = true;
    ...
    c3_s_x = c3_b_theta;
    c3_b_theta = c3_s_x;
    c3_b_theta = muDoubleScalarAcos(c3_b_theta);
  } else {
    _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 53);
    if (CV_EML_IF(0, 1, 5, CV_RELATIONAL_EVAL(4U, 0U, 5, c3_b_em, 1.0E-7, -1, 2U,
          c3_b_em < 1.0E-7))) {
      _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 54);
      for (c3_i46 = 0; c3_i46 < 3; c3_i46++) {
        c3_f_r[c3_i46] = c3_c_r[c3_i46];
      }

      c3_rdivide(chartInstance, c3_f_r, c3_rm, c3_A);
      for (c3_i47 = 0; c3_i47 < 3; c3_i47++) {
        c3_i_A[c3_i47] = c3_A[c3_i47];
      }

      for (c3_i48 = 0; c3_i48 < 3; c3_i48++) {
        c3_dv9[c3_i48] = c3_dv3[c3_i48];
      }

      c3_t_x = c3_dot(chartInstance, c3_i_A, c3_dv9);
      c3_b_theta = c3_t_x;
      guard3 = false;
      if (c3_b_theta < -1.0) {
        guard3 = true;
      ...
      for (c3_i49 = 0; c3_i49 < 3; c3_i49++) {
        c3_g_r[c3_i49] = c3_c_r[c3_i49];
      }

      for (c3_i50 = 0; c3_i50 < 3; c3_i50++) {
        c3_g_v[c3_i50] = c3_c_v[c3_i50];
      }

      c3_d4 = c3_dot(chartInstance, c3_g_r, c3_g_v);
      if (CV_EML_IF(0, 1, 6, CV_RELATIONAL_EVAL(4U, 0U, 6, c3_d4, 0.0, -1, 4U,
            c3_d4 > 0.0))) {
        _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 59);
        for (c3_i51 = 0; c3_i51 < 3; c3_i51++) {
          c3_h_r[c3_i51] = c3_c_r[c3_i51];
        }

        for (c3_i52 = 0; c3_i52 < 3; c3_i52++) {
          c3_f_e[c3_i52] = c3_e[c3_i52];
        }

        c3_j_A = c3_dot(chartInstance, c3_h_r, c3_f_e);
        c3_i_B = c3_rm * c3_b_em;
        c3_v_x = c3_j_A;
        c3_ab_y = c3_i_B;
        c3_w_x = c3_v_x;
        c3_bb_y = c3_ab_y;
        ...
        for (c3_i53 = 0; c3_i53 < 3; c3_i53++) {
          c3_i_r[c3_i53] = c3_c_r[c3_i53];
        }

        for (c3_i54 = 0; c3_i54 < 3; c3_i54++) {
          c3_g_e[c3_i54] = c3_e[c3_i54];
        }

        c3_k_A = c3_dot(chartInstance, c3_i_r, c3_g_e);
        c3_j_B = c3_rm * c3_b_em;
        c3_bb_x = c3_k_A;
        c3_eb_y = c3_j_B;
        c3_cb_x = c3_bb_x;
        c3_fb_y = c3_eb_y;
        ...
        c3_fb_x = muDoubleScalarAcos(c3_fb_x);
        c3_b_theta = 6.2831853071795862 - c3_fb_x;
      }
    }
  }
  ...
  *chartInstance->c3_em = c3_b_em;
  *chartInstance->c3_i = c3_b_i;
  *chartInstance->c3_OM = c3_b_OM;
  *chartInstance->c3_om = c3_b_om;
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_test_hill_simInstanceStruct *chartInstance;
  chartInstance = (SFc3_test_hill_simInstanceStruct *)chartInstanceVoid;
  ...
  real_T c3_y[3])
{
  ...
  int32_T c3_i59;
  (void)chartInstance;
  sf_mex_import(c3_parentId, sf_mex_dup(c3_u), c3_dv10, 1, 0, 0U, 1, 0U, 1, 3);
...
const mxArray *sf_c3_test_hill_sim_get_eml_resolved_functions_info(void)
{
  const mxArray *c3_nameCaptureInfo = NULL;
  c3_nameCaptureInfo = NULL;
  sf_mex_assign(&c3_nameCaptureInfo, sf_mex_createstruct("structure", 2, 71, 1),
                false);
...
static void c3_info_helper(const mxArray **c3_info)
{
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+refblas/xnrm2.p"),
                  "context", "context", 10);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("realmin"), "name", "name", 10);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 10);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+refblas/xnrm2.p"),
                  "context", "context", 23);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("abs"), "name", "name", 23);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 23);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("mrdivide"), "name", "name", 26);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 26);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("mpower"), "name", "name", 33);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 33);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 35);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("ismatrix"), "name", "name", 35);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 35);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 36);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("power"), "name", "name", 36);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 36);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, sf_mex_duplicatearraysafe(&c3_lhs45), "lhs", "lhs",
                  45);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(""), "context", "context", 46);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("cross"), "name", "name", 46);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 46);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("acos"), "name", "name", 47);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 47);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/acos.m"), "resolved",
                  "resolved", 47);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1395328492U), "fileTimeLo",
                  "fileTimeLo", 47);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 47);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/acos.m"), "context",
                  "context", 49);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("eml_scalar_acos"), "name",
                  "name", 49);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 49);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("dot"), "name", "name", 50);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 50);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/specfun/dot.m"), "context",
                  "context", 51);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("isequal"), "name", "name", 51);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 51);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
...
static void c3_b_info_helper(const mxArray **c3_info)
{
  ...
  sf_mex_addfield(*c3_info, sf_mex_duplicatearraysafe(&c3_lhs69), "lhs", "lhs",
                  69);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(""), "context", "context", 70);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("rdivide"), "name", "name", 70);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 70);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "resolved",
                     ...
                     c3_b_a[3], real_T c3_b[3], real_T c3_c[3])
{
  ...
  real_T c3_c3;
  (void)chartInstance;
  c3_c1 = c3_b_a[1] * c3_b[2] - c3_b_a[2] * c3_b[1];
  c3_c2 = c3_b_a[2] * c3_b[0] - c3_b_a[0] * c3_b[2];
  c3_c3 = c3_b_a[0] * c3_b[1] - c3_b_a[1] * c3_b[0];
  c3_c[0] = c3_c1;
  c3_c[1] = c3_c2;
  c3_c[2] = c3_c3;
}
  ...
  c3_x[3], real_T c3_y, real_T c3_z[3])
{
  ...
  for (c3_i62 = 0; c3_i62 < 3; c3_i62++) {
    c3_z[c3_i62] = c3_x[c3_i62] / c3_c_y;
  }
}
                     ...
                     c3_b_a[3], real_T c3_b[3])
{
  ...
  for (c3_i65 = 0; c3_i65 < 3; c3_i65++) {
    c3_c_a[c3_i65] = c3_b_a[c3_i65];
  }

  for (c3_i66 = 0; c3_i66 < 3; c3_i66++) {
    c3_b_b[c3_i66] = c3_b[c3_i66];
  }

  return c3_eml_xdotc(chartInstance, c3_c_a, c3_b_b);
}
  ...
  *c3_identifier)
{
  ...
  c3_y = c3_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_test_hill_sim), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_test_hill_sim);
  return c3_y;
}
...
static void init_simulink_io_address(SFc3_test_hill_simInstanceStruct
  *chartInstance)
{
  chartInstance->c3_r = (real_T (*)[3])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c3_a = (real_T *)ssGetOutputPortSignal_wrapper(chartInstance->S,
    1);
  chartInstance->c3_v = (real_T (*)[3])ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c3_em = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 2);
  chartInstance->c3_i = (real_T *)ssGetOutputPortSignal_wrapper(chartInstance->S,
    3);
  chartInstance->c3_OM = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 4);
  chartInstance->c3_om = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 5);
...
void sf_c3_test_hill_sim_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3440705693U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3963512505U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1408690325U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(46035546U);
}

mxArray* sf_c3_test_hill_sim_get_post_codegen_info(void);
mxArray *sf_c3_test_hill_sim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("qeIpyoXjADvIjVAro9fseG");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c3_test_hill_sim_get_post_codegen_info();
...
mxArray *sf_c3_test_hill_sim_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_test_hill_sim_jit_fallback_info(void)
{
...
mxArray *sf_c3_test_hill_sim_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c3_test_hill_sim(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[9],T\"OM\",},{M[1],M[5],T\"a\",},{M[1],M[7],T\"em\",},{M[1],M[8],T\"i\",},{M[1],M[10],T\"om\",},{M[1],M[11],T\"theta\",},{M[8],M[0],T\"is_active_c3_test_hill_sim\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 7, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_test_hill_sim_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_test_hill_simInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_SET_DATA_VALUE_PTR(3U, chartInstance->c3_em);
        _SFD_SET_DATA_VALUE_PTR(4U, chartInstance->c3_i);
        _SFD_SET_DATA_VALUE_PTR(5U, chartInstance->c3_OM);
        _SFD_SET_DATA_VALUE_PTR(6U, chartInstance->c3_om);
        _SFD_SET_DATA_VALUE_PTR(7U, chartInstance->c3_theta);
      }
    } else {
...
{
  return "wN4GAzBP5nj64wAY1Cd8aD";
}

static void sf_opaque_initialize_c3_test_hill_sim(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_test_hill_simInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_test_hill_sim((SFc3_test_hill_simInstanceStruct*)
    chartInstanceVar);
  initialize_c3_test_hill_sim((SFc3_test_hill_simInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c3_test_hill_sim(void *chartInstanceVar)
{
  enable_c3_test_hill_sim((SFc3_test_hill_simInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_test_hill_sim(void *chartInstanceVar)
{
  disable_c3_test_hill_sim((SFc3_test_hill_simInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_test_hill_sim(void *chartInstanceVar)
{
  sf_gateway_c3_test_hill_sim((SFc3_test_hill_simInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c3_test_hill_sim(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c3_test_hill_sim((SFc3_test_hill_simInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c3_test_hill_sim(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c3_test_hill_sim((SFc3_test_hill_simInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c3_test_hill_sim(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_test_hill_simInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c3_test_hill_sim((SFc3_test_hill_simInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc3_test_hill_sim((SFc3_test_hill_simInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_test_hill_sim(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_test_hill_sim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1157111403U));
  ssSetChecksum1(S,(1334065574U));
  ssSetChecksum2(S,(680974471U));
  ssSetChecksum3(S,(836929232U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c3_test_hill_sim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_test_hill_sim(SimStruct *S)
{
  SFc3_test_hill_simInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_test_hill_simInstanceStruct *)utMalloc(sizeof
    (SFc3_test_hill_simInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_test_hill_simInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c3_test_hill_sim;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_test_hill_sim;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c3_test_hill_sim;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_test_hill_sim;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_test_hill_sim;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_test_hill_sim;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_test_hill_sim;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_test_hill_sim;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_test_hill_sim;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_test_hill_sim;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_test_hill_sim;
...
void c3_test_hill_sim_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_test_hill_sim(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_test_hill_sim(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_test_hill_sim(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_test_hill_sim_method_dispatcher.\n"
