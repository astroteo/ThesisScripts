...
static const char * c6_debug_family_names[5] = { "v_t", "r_t", "nargin",
  "nargout", "W" };

/* Function Declarations */
static void initialize_c6_test_hill_sim(SFc6_test_hill_simInstanceStruct
  *chartInstance);
static void initialize_params_c6_test_hill_sim(SFc6_test_hill_simInstanceStruct *
  chartInstance);
static void enable_c6_test_hill_sim(SFc6_test_hill_simInstanceStruct
  *chartInstance);
static void disable_c6_test_hill_sim(SFc6_test_hill_simInstanceStruct
  *chartInstance);
static void c6_update_debugger_state_c6_test_hill_sim
  (SFc6_test_hill_simInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c6_test_hill_sim
  (SFc6_test_hill_simInstanceStruct *chartInstance);
static void set_sim_state_c6_test_hill_sim(SFc6_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c6_st);
static void finalize_c6_test_hill_sim(SFc6_test_hill_simInstanceStruct
  *chartInstance);
static void sf_gateway_c6_test_hill_sim(SFc6_test_hill_simInstanceStruct
  *chartInstance);
static void mdl_start_c6_test_hill_sim(SFc6_test_hill_simInstanceStruct
  *chartInstance);
static void initSimStructsc6_test_hill_sim(SFc6_test_hill_simInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber, uint32_T c6_instanceNumber);
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData);
static void c6_emlrt_marshallIn(SFc6_test_hill_simInstanceStruct *chartInstance,
  const mxArray *c6_b_W, const char_T *c6_identifier, real_T c6_y[3]);
static void c6_b_emlrt_marshallIn(SFc6_test_hill_simInstanceStruct
...
static const mxArray *c6_c_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static real_T c6_c_emlrt_marshallIn(SFc6_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
...
static real_T c6_eml_xnrm2(SFc6_test_hill_simInstanceStruct *chartInstance,
  real_T c6_x[3]);
static void c6_below_threshold(SFc6_test_hill_simInstanceStruct *chartInstance);
static void c6_eml_scalar_eg(SFc6_test_hill_simInstanceStruct *chartInstance);
static const mxArray *c6_d_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static int32_T c6_d_emlrt_marshallIn(SFc6_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static uint8_T c6_e_emlrt_marshallIn(SFc6_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c6_b_is_active_c6_test_hill_sim, const char_T
  *c6_identifier);
static uint8_T c6_f_emlrt_marshallIn(SFc6_test_hill_simInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void init_dsm_address_info(SFc6_test_hill_simInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc6_test_hill_simInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_test_hill_sim = 0U;
}
  ...
  (SFc6_test_hill_simInstanceStruct *chartInstance)
{
  ...
  for (c6_i0 = 0; c6_i0 < 3; c6_i0++) {
    c6_u[c6_i0] = (*chartInstance->c6_W)[c6_i0];
  }

  c6_b_y = NULL;
  sf_mex_assign(&c6_b_y, sf_mex_create("y", c6_u, 0, 0U, 1U, 0U, 1, 3), false);
  sf_mex_setcell(c6_y, 0, c6_b_y);
  c6_hoistedGlobal = chartInstance->c6_is_active_c6_test_hill_sim;
  ...
  *chartInstance, const mxArray *c6_st)
{
  ...
  c6_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c6_u, 0)), "W",
                      c6_dv0);
  for (c6_i1 = 0; c6_i1 < 3; c6_i1++) {
    (*chartInstance->c6_W)[c6_i1] = c6_dv0[c6_i1];
  }

  chartInstance->c6_is_active_c6_test_hill_sim = c6_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c6_u, 1)),
     "is_active_c6_test_hill_sim");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_test_hill_sim(chartInstance);
  ...
  *chartInstance)
{
  ...
  for (c6_i2 = 0; c6_i2 < 3; c6_i2++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c6_r_t)[c6_i2], 0U);
  }

  chartInstance->c6_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 5U, chartInstance->c6_sfEvent);
  for (c6_i3 = 0; c6_i3 < 3; c6_i3++) {
    c6_b_r_t[c6_i3] = (*chartInstance->c6_r_t)[c6_i3];
  }

  for (c6_i4 = 0; c6_i4 < 3; c6_i4++) {
    c6_b_v_t[c6_i4] = (*chartInstance->c6_v_t)[c6_i4];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 5U, 7U, c6_debug_family_names,
    c6_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c6_c_v_t, MAX_uint32_T, c6_sf_marshallOut,
    c6_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c6_c_r_t, MAX_uint32_T, c6_sf_marshallOut,
    c6_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c6_nargout, 3U, c6_c_sf_marshallOut,
    c6_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c6_b_r_t, 1U, c6_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c6_b_v_t, 0U, c6_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c6_b_W, 4U, c6_sf_marshallOut,
    c6_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c6_sfEvent, 3);
  c6_c_v_t[0] = c6_b_v_t[0];
  c6_c_v_t[1] = c6_b_v_t[1];
  c6_c_v_t[2] = c6_b_v_t[2];
  _SFD_SYMBOL_SWITCH(0U, 0U);
  _SFD_EML_CALL(0U, chartInstance->c6_sfEvent, 4);
  c6_c_r_t[0] = c6_b_r_t[0];
  c6_c_r_t[1] = c6_b_r_t[1];
  c6_c_r_t[2] = c6_b_r_t[2];
  ...
  for (c6_i6 = 0; c6_i6 < 3; c6_i6++) {
    c6_a[c6_i6] = c6_c_r_t[c6_i6];
  }

  for (c6_i7 = 0; c6_i7 < 3; c6_i7++) {
    c6_b[c6_i7] = c6_c_v_t[c6_i7];
  }

  c6_c1 = c6_a[1] * c6_b[2] - c6_a[2] * c6_b[1];
  c6_c2 = c6_a[2] * c6_b[0] - c6_a[0] * c6_b[2];
  c6_c3 = c6_a[0] * c6_b[1] - c6_a[1] * c6_b[0];
  c6_a[0] = c6_c1;
  c6_a[1] = c6_c2;
  c6_a[2] = c6_c3;
  for (c6_i8 = 0; c6_i8 < 3; c6_i8++) {
    c6_b[c6_i8] = c6_c_r_t[c6_i8];
  }
  ...
  c6_y = c6_eml_xnrm2(chartInstance, c6_b_b);
  c6_b_a = c6_y;
  c6_c_a = c6_b_a;
  c6_d_a = c6_c_a;
  ...
  for (c6_i10 = 0; c6_i10 < 3; c6_i10++) {
    c6_b_W[c6_i10] = c6_a[c6_i10] / c6_d_y;
  }

  _SFD_EML_CALL(0U, chartInstance->c6_sfEvent, -6);
  _SFD_SYMBOL_SCOPE_POP();
  for (c6_i11 = 0; c6_i11 < 3; c6_i11++) {
    (*chartInstance->c6_W)[c6_i11] = c6_b_W[c6_i11];
  }
  ...
  for (c6_i12 = 0; c6_i12 < 3; c6_i12++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c6_W)[c6_i12], 1U);
  }

  for (c6_i13 = 0; c6_i13 < 3; c6_i13++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c6_v_t)[c6_i13], 2U);
  }
}
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  const mxArray *c6_y = NULL;
  SFc6_test_hill_simInstanceStruct *chartInstance;
  chartInstance = (SFc6_test_hill_simInstanceStruct *)chartInstanceVoid;
  ...
  const mxArray *c6_b_W, const char_T *c6_identifier, real_T c6_y[3])
{
  ...
  c6_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c6_b_W), &c6_thisId, c6_y);
  sf_mex_destroy(&c6_b_W);
}
  ...
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData)
{
  ...
  SFc6_test_hill_simInstanceStruct *chartInstance;
  chartInstance = (SFc6_test_hill_simInstanceStruct *)chartInstanceVoid;
  c6_b_W = sf_mex_dup(c6_mxArrayInData);
  ...
  for (c6_i17 = 0; c6_i17 < 3; c6_i17++) {
    (*(real_T (*)[3])c6_outData)[c6_i17] = c6_y[c6_i17];
  }
...
const mxArray *sf_c6_test_hill_sim_get_eml_resolved_functions_info(void)
{
  const mxArray *c6_nameCaptureInfo = NULL;
  c6_nameCaptureInfo = NULL;
  sf_mex_assign(&c6_nameCaptureInfo, sf_mex_createstruct("structure", 2, 47, 1),
                false);
...
static void c6_info_helper(const mxArray **c6_info)
{
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("cross"), "name", "name", 0);
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/specfun/cross.m"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1286818842U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/norm.m"), "resolved",
                  "resolved", 1);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1363713868U), "fileTimeLo",
                  "fileTimeLo", 1);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 1);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+blas/inline.p"),
                  "resolved", "resolved", 5);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1410807772U), "fileTimeLo",
                  "fileTimeLo", 5);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 5);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_switch_helper.m"),
                  "resolved", "resolved", 9);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1393330858U), "fileTimeLo",
                  "fileTimeLo", 9);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 9);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1397257422U), "fileTimeLo",
                  "fileTimeLo", 17);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 17);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 18);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("isfi"), "name", "name", 18);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("coder.internal.indexInt"),
                  "dominantType", "dominantType", 18);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/fixedpoint/isfi.m"), "resolved",
                  "resolved", 18);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1346510358U), "fileTimeLo",
                  "fileTimeLo", 18);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 18);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/fixedpoint/isnumerictype.m"), "resolved",
                  "resolved", 19);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1398875598U), "fileTimeLo",
                  "fileTimeLo", 19);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 19);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 22);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("intmin"), "name", "name", 22);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 22);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+refblas/xnrm2.p"),
                  "context", "context", 24);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("abs"), "name", "name", 24);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 24);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("mpower"), "name", "name", 27);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 27);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 29);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("ismatrix"), "name", "name", 29);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 29);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 30);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("power"), "name", "name", 30);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 30);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m"), "resolved",
                  "resolved", 30);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1395328506U), "fileTimeLo",
                  "fileTimeLo", 30);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 30);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m!fltpower"), "context",
                  "context", 36);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("floor"), "name", "name", 36);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 36);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c6_info, sf_mex_duplicatearraysafe(&c6_lhs39), "lhs", "lhs",
                  39);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(""), "context", "context", 40);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("mrdivide"), "name", "name", 40);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 40);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "context",
                  "context", 42);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("rdivide"), "name", "name", 42);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 42);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 45);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("eml_div"), "name", "name", 45);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 45);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  *c6_identifier)
{
  ...
  c6_y = c6_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c6_b_is_active_c6_test_hill_sim), &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_test_hill_sim);
  return c6_y;
}
...
static void init_simulink_io_address(SFc6_test_hill_simInstanceStruct
  *chartInstance)
{
  chartInstance->c6_r_t = (real_T (*)[3])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c6_W = (real_T (*)[3])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c6_v_t = (real_T (*)[3])ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
}
...
void sf_c6_test_hill_sim_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(761206338U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3939911996U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2338168554U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(112241719U);
}

mxArray* sf_c6_test_hill_sim_get_post_codegen_info(void);
mxArray *sf_c6_test_hill_sim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("e3MVNLCwSeBYQf3Q1bYj2");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c6_test_hill_sim_get_post_codegen_info();
...
mxArray *sf_c6_test_hill_sim_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c6_test_hill_sim_jit_fallback_info(void)
{
...
mxArray *sf_c6_test_hill_sim_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c6_test_hill_sim(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"W\",},{M[8],M[0],T\"is_active_c6_test_hill_sim\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_test_hill_sim_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc6_test_hill_simInstanceStruct *)
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,1,1,0,"r_t");
          _SFD_SET_DATA_PROPS(1,2,0,1,"W");
          _SFD_SET_DATA_PROPS(2,1,1,0,"v_t");
        ...
        _SFD_SET_DATA_VALUE_PTR(0U, *chartInstance->c6_r_t);
        _SFD_SET_DATA_VALUE_PTR(1U, *chartInstance->c6_W);
        _SFD_SET_DATA_VALUE_PTR(2U, *chartInstance->c6_v_t);
      }
    } else {
...
{
  return "VNIU2KUAjpdfiQCWOeG2F";
}

static void sf_opaque_initialize_c6_test_hill_sim(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_test_hill_simInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c6_test_hill_sim((SFc6_test_hill_simInstanceStruct*)
    chartInstanceVar);
  initialize_c6_test_hill_sim((SFc6_test_hill_simInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c6_test_hill_sim(void *chartInstanceVar)
{
  enable_c6_test_hill_sim((SFc6_test_hill_simInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c6_test_hill_sim(void *chartInstanceVar)
{
  disable_c6_test_hill_sim((SFc6_test_hill_simInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c6_test_hill_sim(void *chartInstanceVar)
{
  sf_gateway_c6_test_hill_sim((SFc6_test_hill_simInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c6_test_hill_sim(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c6_test_hill_sim((SFc6_test_hill_simInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c6_test_hill_sim(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c6_test_hill_sim((SFc6_test_hill_simInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c6_test_hill_sim(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_test_hill_simInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c6_test_hill_sim((SFc6_test_hill_simInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc6_test_hill_sim((SFc6_test_hill_simInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_test_hill_sim(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c6_test_hill_sim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2305803798U));
  ssSetChecksum1(S,(1305578549U));
  ssSetChecksum2(S,(2641039600U));
  ssSetChecksum3(S,(2893911747U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c6_test_hill_sim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_test_hill_sim(SimStruct *S)
{
  SFc6_test_hill_simInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc6_test_hill_simInstanceStruct *)utMalloc(sizeof
    (SFc6_test_hill_simInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc6_test_hill_simInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c6_test_hill_sim;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c6_test_hill_sim;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c6_test_hill_sim;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c6_test_hill_sim;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c6_test_hill_sim;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c6_test_hill_sim;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c6_test_hill_sim;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c6_test_hill_sim;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_test_hill_sim;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_test_hill_sim;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c6_test_hill_sim;
...
void c6_test_hill_sim_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_test_hill_sim(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_test_hill_sim(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_test_hill_sim(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_test_hill_sim_method_dispatcher.\n"
